 ...
 */
class Ves_Optimize_Model_Container_CatalogProductItem
    extends Ves_Optimize_Model_Container_Advanced_Quote
{
     ...
     *
     * @var null|Ves_TargetRule_Block_Catalog_Product_List_Abstract
     */
    ...
    protected function _getListBlockType()
    {
        ...
        if ($blockName == self::BLOCK_NAME_RELATED) {
            return 'ves_targetrule/catalog_product_list_related';
        } elseif ($blockName == self::BLOCK_NAME_UPSELL) {
            return 'ves_targetrule/catalog_product_list_upsell';
        }
        ...
        if (is_null($this->_infoCacheId)) {
            $this->_infoCacheId = 'CATALOG_PRODUCT_LIST_SHARED_'
                . md5($this->_placeholder->getName()
                    . $this->_getCookieValue(Ves_Optimize_Model_Cookie::COOKIE_CART, '')
                    . $this->_getProductId());
        }
     ...
     *
     * @return false|Ves_TargetRule_Block_Catalog_Product_List_Abstract
     */
