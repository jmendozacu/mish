 ...
 */
class Ves_Optimize_Model_Container_Sidebar_Cart extends Ves_Optimize_Model_Container_Advanced_Quote
{
    /**
    ...
    {
        return $this->_getCookieValue(Ves_Optimize_Model_Cookie::COOKIE_CART, '')
