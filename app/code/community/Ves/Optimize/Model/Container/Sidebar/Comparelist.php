 ...
 */
class Ves_Optimize_Model_Container_Sidebar_Comparelist extends Ves_Optimize_Model_Container_Abstract
{
    /**
    ...
    {
        return $this->_getCookieValue(Ves_Optimize_Model_Cookie::COOKIE_COMPARE_LIST, '');
    }
