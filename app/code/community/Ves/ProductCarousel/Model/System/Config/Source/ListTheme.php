<?php
class Ves_ProductCarousel_Model_System_Config_Source_ListTheme
{
    ...
    public function toOptionArray()
    {
		...
		$directory = Mage::getBaseDir('design') . DS . 'frontend' . DS . 'base' . DS . 'default' .  DS . 'template'.  DS . 'ves'. DS .'slidingcaption';
