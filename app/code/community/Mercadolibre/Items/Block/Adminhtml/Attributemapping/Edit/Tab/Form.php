...
class Mercadolibre_Items_Block_Adminhtml_Attributemapping_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      $form = new Varien_Data_Form();
      $this->setForm($form);
      $fieldset = $form->addFieldset('items_form', array('legend'=>Mage::helper('items')->__('Import Attribute Mapping')));
