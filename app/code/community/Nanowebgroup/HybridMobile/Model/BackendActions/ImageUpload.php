...
class Nanowebgroup_HybridMobile_Model_BackendActions_ImageUpload extends Mage_Core_Model_Config_Data
{

    /**
	 * Thanks to Branko Ajzele for the following code - http://inchoo.net
	 *
