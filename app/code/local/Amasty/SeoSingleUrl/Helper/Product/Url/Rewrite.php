...
if (! Amasty_SeoSingleUrl_Helper_Data::urlRewriteHelperEnabled()) {
	abstract class Amasty_SeoSingleUrl_Helper_Product_Url_Rewrite_Abstract
	{}
} else {
	abstract class Amasty_SeoSingleUrl_Helper_Product_Url_Rewrite_Abstract extends Mage_Catalog_Helper_Product_Url_Rewrite
	{}
};

class Amasty_SeoSingleUrl_Helper_Product_Url_Rewrite
    extends Amasty_SeoSingleUrl_Helper_Product_Url_Rewrite_Abstract
{
	...
	public function getTableSelect(array $productIds, $categoryId, $storeId, $items = array('product_id', 'request_path'))
    {
		...
		$storeId = Mage::registry('amseourl_store_id') ? Mage::registry('amseourl_store_id') : $storeId;
