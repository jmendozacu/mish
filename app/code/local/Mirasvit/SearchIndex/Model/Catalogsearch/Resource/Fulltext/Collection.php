...
if (class_exists('Mage_CatalogSearch_Model_Resource_Fulltext_Collection')) {
    class Mirasvit_SearchIndex_Model_Catalogsearch_Resource_Fulltext_Collection_Amasty_Pure extends Mage_CatalogSearch_Model_Resource_Fulltext_Collection
    {
    }
} else {
    class Mirasvit_SearchIndex_Model_Catalogsearch_Resource_Fulltext_Collection_Amasty_Pure extends Mage_CatalogSearch_Model_Mysql4_Fulltext_Collection
    {
    }
}

class Mirasvit_SearchIndex_Model_Catalogsearch_Resource_Fulltext_Collection extends Mirasvit_SearchIndex_Model_Catalogsearch_Resource_Fulltext_Collection_Amasty_Pure
{
