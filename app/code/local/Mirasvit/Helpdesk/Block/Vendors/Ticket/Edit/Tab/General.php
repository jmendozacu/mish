...
class Mirasvit_Helpdesk_Block_Vendors_Ticket_Edit_Tab_General extends Mage_Adminhtml_Block_Widget_Form
{
...
<button type='button' id='find-customer-btn' data-url='".Mage::helper("adminhtml")->getUrl('helpdesk/vendors_ticket/customerfind')."'><span>".Mage::helper('helpdesk')->__('Find Customer')."</span></button>
            ");
             ...
             // $element->setAfterElementHtml('<button id="find-customer-btn" title="WYSIWYG Editor" type="button" class="scalable btn-wysiwyg" onclick="catalogWysiwygEditor.open('.Mage::helper("adminhtml")->getUrl('helpdeskadmin/adminhtml_ticket/customerfind').','"description"')"><span><span><span>WYSIWYG Editor</span></span></span></button>');
...
<div id='reply_note'></div>
    ...
    protected function _toHtml()
    {
        ...
        $messages = $this->getLayout()->createBlock('helpdesk/vendors_ticket_edit_tab_messages')->toHtml();
