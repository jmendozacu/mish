...
class Mirasvit_Helpdesk_Block_Vendors_Sales_Order_View_Tabs_Ticket extends Mage_Adminhtml_Block_Widget
implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _toHtml()
    {
        ...
        $ticketNewUrl = $this->getUrl('vendors/vendors_ticket/add', array('order_id' => $id));
