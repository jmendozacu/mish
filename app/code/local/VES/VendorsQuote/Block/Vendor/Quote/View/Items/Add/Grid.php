<?php
class VES_VendorsQuote_Block_Vendor_Quote_View_Items_Add_Grid extends Mage_Adminhtml_Block_Widget_Grid
{

    public function __construct()
    {
        parent::__construct();
        $this->setId('vendors_quote_create_search_grid');
        $this->setRowClickCallback('quotation.productGridRowClick.bind(quotation)');
        $this->setCheckboxCheckCallback('quotation.productGridCheckboxCheck.bind(quotation)');
        $this->setRowInitCallback('quotation.productGridRowInit.bind(quotation)');
        $this->setAdditionalJavaScript("quotation.setGrid(".$this->getJsObjectName().");\n");
    ...
    {
        return $this->getUrl('*/*/loadProductGrid', array('block'=>'search_grid', '_current' => true, 'collapse' => null));
    }
