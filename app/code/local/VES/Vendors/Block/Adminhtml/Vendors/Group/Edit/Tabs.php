...
class VES_Vendors_Block_Adminhtml_Vendors_Group_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
	...
	protected function _beforeToHtml()
	{
		...
		$this->addTab('main_sections', array(
			'label'     => Mage::helper('vendors')->__('Select Category'),
			'title'     => Mage::helper('vendors')->__('Select Category'),
			 'content'   => $this->getLayout()->createBlock('vendors/adminhtml_vendors_group_edit_tab_tabid')->toHtml(),
		));
