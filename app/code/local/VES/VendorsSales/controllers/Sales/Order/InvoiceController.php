<?php
class VES_VendorsSales_Sales_Order_InvoiceController extends VES_Vendors_Controller_Action
{
    /**
    ...
    public function viewAction()
    {
        ...
        if ($invoice) {
            ...
            $this->loadLayout()
                ...
                ->_addBreadcrumb($this->__('Invoices'), $this->__('Orders'),Mage::getUrl('vendors/sales_invoice'))
                ->_addBreadcrumb($this->__('View Invoice'), $this->__('View Invoice'));
    ...
    public function newAction()
    {
        ...
        if ($invoice) {
            ...
            $this->loadLayout()
                ->_setActiveMenu('sales/order')
                ->_addBreadcrumb($this->__('Sales'), $this->__('Sales'))
                ->_addBreadcrumb($this->__('Orders'), $this->__('Orders'),Mage::getUrl('vendors/sales_order_invoice'))
                ->_addBreadcrumb($this->__('View Order'), $this->__('View Order'),Mage::getUrl('vendors/sales_order_invoice/view',array('order_id'=>$invoice->getOrderId())))
                ->_addBreadcrumb($this->__('New Invoice'), $this->__('New Invoice'))
                ->renderLayout();
        } else {
    ...
    public function saveAction()
    {
        ...
        try {
            ...
            if ($invoice) {
                ...
                //var_dump($invoice->getOrder()->getData());exit;
