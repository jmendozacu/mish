...
//            $this->_initLayoutMessages('adminhtml/session');
		...
		if ($data = $this->getRequest()->getPost()) {
            ...
            if(!$category->getId()) {
                ...
                $collection = Mage::getModel('vendorscategory/category')->getCollection()
                    ...
                    ->addFieldToFilter('parent_category_id',$parent);
                ...
                if($collection->count()) {
                    ...
                    $max_sort_order = $collection->getFirstItem()->getData('sort_order');
                ...
                $category->setData('sort_order',$sort_order);
...

    {
        ...
        $this->getResponse()->setBody(
            ...
            $this->getLayout()->createBlock('vendorscategory/vendor_category_tab_product', 'vendor.category.product.grid')
