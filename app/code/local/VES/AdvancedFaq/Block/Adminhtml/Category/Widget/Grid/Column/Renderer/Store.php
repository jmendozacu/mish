<?php
class OTTO_AdvancedFaq_Block_Adminhtml_Category_Widget_Grid_Column_Renderer_Store extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Store
{
    public function render(Varien_Object $row)
    {
    	$value_status	= $row->getData($this->getColumn()->getIndex());
    	if($value_status == 0) return $this->__("All Store View");
    	else{
    		$out = '';
    	...
    	//return Mage::getModel('kbase/attribute_source_store')->getStoreName($value_status);
    }
