...
class OTTO_AdvancedFaq_Adminhtml_Advancedfaq_FaqController extends Mage_Adminhtml_Controller_Action
{
	...
	public function editAction() {
		...
		if ($model->getId() || $id == 0) {
			...
			$this->_addContent($this->getLayout()->createBlock('advancedfaq/adminhtml_faq_edit'))
				->_addLeft($this->getLayout()->createBlock('advancedfaq/adminhtml_faq_edit_tabs'));

			$this->renderLayout();
		} else {
			Mage::getSingleton('adminhtml/session')->addError(Mage::helper('advancedfaq')->__('FAQ does not exist'));
			$this->_redirect('*/*/');
		}
	}
	...
	public function saveAction() {
		if ($data = $this->getRequest()->getPost()) {
			...
			try {
				...
				Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('advancedfaq')->__('FAQ was successfully saved'));
    ...
    public function massDeleteAction() {
        $kbaseIds = $this->getRequest()->getParam('faq');
