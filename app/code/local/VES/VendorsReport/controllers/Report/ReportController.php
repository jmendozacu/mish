...
class VES_VendorsReport_Report_ReportController extends VES_VendorsReport_Controller_Abstract {
    ...
    protected function _isAllowed() {
        return true;
//        return Mage::getSingleton('vendors/session')->isAllowed('inventoryplus/report');
    }
