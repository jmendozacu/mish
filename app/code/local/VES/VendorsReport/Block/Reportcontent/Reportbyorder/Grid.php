 ...
 */
class VES_VendorsReport_Block_Reportcontent_Reportbyorder_Grid extends Magestore_Inventoryreports_Block_Adminhtml_Reportcontent_Grid {
    ...
    protected function _prepareCollection() {
        $data = Mage::helper('vendorsreport/order')->getOrderReportCollection($this->getRequestData());
        if (is_array($data)) {
    ...
    protected function _prepareColumns() {
        ...
        if (!$this->isSalesSupplierReport()) {
            $this->addColumn('sales_ratio', array(
                ...
                'sortable' => false,
                'width' => '50px',
                'renderer' => 'vendorsreport/reportcontent_reportbyorder_renderer_salesratio'
            ));
        }
        ...
        $this->addColumn('action', array(
            ...
            'index' => 'stores',
            'is_system' => true,
            'renderer' => 'vendorsreport/reportcontent_reportbyorder_renderer_action'
        ));
    ...
    public function getTotals() {
        ...
        //calculate ratio
        $renderer = $this->getLayout()->createBlock('vendorsreport/reportcontent_reportbyorder_renderer_salesratio');
    ...
    public function getGridUrl() {
        return $this->getUrl('vendors/report_report/reportordergrid', array('type_id' => 'sales', 'top_filter' => $this->getRequest()->getParam('top_filter'))
        );
    }
