 ...
 */
class VES_VendorsReport_Block_Reportcontent_Reportbyorder_Renderer_Action extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        $orderUrl = Mage::helper("adminhtml")->getUrl('vendors/report_sales/orders', array('top_filter' => $filter, "_secure" => Mage::app()->getStore()->isCurrentlySecure()));
        ...
        if ($this->getColumn()->getGrid()->isSalesSKUReport()) {
            ...
            $stockHistoryUrl = $this->getUrl('vendors/report_product/chart', array('id' => $productId));
