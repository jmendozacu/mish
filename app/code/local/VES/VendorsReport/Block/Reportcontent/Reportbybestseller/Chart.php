 ...
 */
class VES_VendorsReport_Block_Reportcontent_Reportbybestseller_Chart extends Magestore_Inventoryreports_Block_Adminhtml_Reportcontent_Chart {

    protected function _prepareLayout() {
        $this->setTemplate('ves_vendorsinventory/reports/chart/chart-content/bestseller/chart.phtml');
    ...
    public function getBestSellerProduct() {
        ...
        $productCollection = Mage::helper('vendorsreport/bestseller')
