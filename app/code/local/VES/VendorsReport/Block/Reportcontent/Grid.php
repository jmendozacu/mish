 ...
 */
abstract class VES_VendorsReport_Block_Reportcontent_Grid extends Magestore_Inventoryplus_Block_Adminhtml_Widget_Grid {
    ...
    protected function _addWarehouseCoulmn($render) {
        ...
        $warehouses = $this->helper('vendorsreport')->getAllWarehouseName();
