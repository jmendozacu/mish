 ...
 */
class VES_VendorsReport_Block_Reportcontent_Reportbymovement_Renderer_Action extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {        
        ...
        $productUrl = Mage::helper("adminhtml")->getUrl('vendors/report_product/details',array('top_filter'=>$filter,"_secure" => Mage::app()->getStore()->isCurrentlySecure()));
