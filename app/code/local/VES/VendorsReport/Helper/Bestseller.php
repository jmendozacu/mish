 ...
 */
class VES_VendorsReport_Helper_Bestseller extends Mage_Core_Helper_Abstract {
    ...
    public function getBestSellerProductCollection($requestData){
        ...
        $productCollection->getSelect()->join(
                array('vendor' => $productCollection->getTable('vendors/vendor')), 'order.vendor_id = vendor.entity_id and vendor.entity_id='.$vendorId, array('vendor_id')
        );
