 ...
 */
abstract class VES_VendorsReport_Controller_Abstract extends VES_Vendors_Controller_Action
{
    /**
	...
	public function getUrl($code, $params = array()){
		return Mage::getUrl($code,$params);
	}
