 ...
 */
class VES_VendorsInventory_Block_Supplier_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
    ...
    public function __construct() {
        ...
        $this->_formScripts[] = "
            ...
            function uploadFile() {
                ...
                xhr.open('POST', '" . $this->getUrl('vendors/inventory_supplier/importproduct') . "');
                xhr.send(fd);
           }
           ...
           function showhistory(supplierHistoryId){
                var url = '" . $this->getUrl('vendors/inventory_supplier/showhistory') . "';               
    ...
    public function getHeaderText() {
        if (Mage::registry('vendorsinventory_supplier_data')
                && Mage::registry('vendorsinventory_supplier_data')->getId()
        ) {
            return Mage::helper('vendorsinventory')->__("View Supplier '%s'", $this->htmlEscape(Mage::registry('vendorsinventory_supplier_data')->getSupplierName())
            );
        }
        return Mage::helper('vendorsinventory')->__('Add Supplier');
    }
