 ...
 */
class VES_VendorsInventory_Block_Supplier_Edit_Tab_Returnorder extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumnsOldVersion() {
        ...
        $this->addColumn('grand_total_excl_tax', array(
            ...
            'type' => 'price',
            'index' => 'total_amount',
            'renderer' => 'VES_VendorsInventory_Block_Supplier_Renderertotalexcl',
        ));
        ...
        $this->addColumn('action', array(
            ...
            'actions' => array(
                array(
                    ...
                    'url' => array('base' => 'vendors/inventory_purchaseorders/edit'),
                    'field' => 'id'
            )),
            'filter' => false,
            'sortable' => false,
    ...
    public function getRowUrl($row) {
        return $this->getUrl('vendors/inventory_purchaseorders/edit', array('id' => $row->getPurchaseOrderId(),'active' => 'return'));
    }
