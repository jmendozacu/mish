...
class VES_VendorsInventory_Block_Supplier_Edit_Tab_History extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('field_change', array(
            ...
            'renderer' => 'vendorsinventory/supplier_edit_tab_renderer_fieldchanged',
        ...
        $this->addColumn('show_history', array(
            ...
            'filter' => false,
            'sortable' => false,
            'renderer' => 'vendorsinventory/supplier_edit_tab_renderer_history'
        ));
    ...
    public function filterCallback($collection, $column)
    {
        ...
        if (!is_null(@$value)) {
            ...
            if($id = $this->getRequest()->getParam('id')){
                $histories = Mage::getResourceModel('inventorypurchasing/supplier_historycontent_collection')
                                    ->addFieldToFilter('field_name', array('like' => "%$value%"));
                if($histories->getSize())
                foreach ($histories as $history) {
                    $supplierHistoryIds[] = $history->getData('supplier_history_id');
                }
            }
