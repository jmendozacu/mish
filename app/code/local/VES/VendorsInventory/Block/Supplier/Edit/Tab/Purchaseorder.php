 ...
 */
class VES_VendorsInventory_Block_Supplier_Edit_Tab_Purchaseorder extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('grand_total_incl_tax', array(
            ...
            'type' => 'number',
            'index' => 'total_amount',
            'renderer' => 'VES_VendorsInventory_Block_Supplier_Renderertotalincl',
        ));
        ...
        $this->addColumn('status', array(
            ...
            'index' => 'status',
            'type' => 'options',
            'options' => Mage::helper('vendorsinventory/purchaseorder')->getPurchaseOrderStatus()
        ));
