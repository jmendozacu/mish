 ...
 */
class VES_VendorsInventory_Block_Inventorysupplyneeds_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
        ...
        if (!$this->_isExport && Mage::helper('core')->isModuleEnabled('Magestore_Inventoryreports')) {
            $this->addColumn('action', array(
                ...
                'index' => 'stores',
                'is_system' => true,
                'renderer' => 'vendorsinventory/inventorysupplyneeds_renderer_action'
            ));
        }
