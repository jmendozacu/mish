 ...
 */
class VES_VendorsInventory_Block_Inventorysupplyneeds_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        if (Mage::getSingleton('vendors/session')->getInventorysupplyneedsData()) {
            $data = Mage::getSingleton('vendors/session')->getInventorysupplyneedsData();
            Mage::getSingleton('vendors/session')->setInventorysupplyneedsData(null);
