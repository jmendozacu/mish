 ...
 */
class VES_VendorsInventory_Block_Warehouse_Region extends Mage_Core_Block_Template
{
    ...
    public function canEdit()
    {
        ...
        if(Mage::helper('vendorsinventory/warehouse')->canEdit($admin->getId(), $warehouse->getId()))
            $canEdit = true;
        return $canEdit;
    }
}