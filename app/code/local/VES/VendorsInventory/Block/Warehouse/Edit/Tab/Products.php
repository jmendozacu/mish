 ...
 */
class VES_VendorsInventory_Block_Warehouse_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $check = Mage::helper('vendorsinventory/warehouse')->canEdit($adminId, $warehouse);
...
//        ));
    ...
    public function _getDisabledProducts() {
        ...
        if (!$warehouse)
            return $products;
        $productCollection = Mage::getModel('inventoryplus/warehouse_product')
                ->getCollection()
    ...
    public function getWarehouse() {
        if (!$warehouse = Mage::registry('warehouse_data')) {
            $warehouse = Mage::getModel('inventoryplus/warehouse')
                    ->load($this->getRequest()->getParam('id'));
            Mage::register('warehouse_data', $warehouse);
        }
        return $warehouse;
    }
