...
class VES_VendorsInventory_Block_Adjuststock_Listadjuststock_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('adjust_status', array(
            ...
            'type' => 'options',
            'options' => array(
                Magestore_Inventoryplus_Model_Adjuststock::STATUS_PENDING => $this->__('Pending'),
                Magestore_Inventoryplus_Model_Adjuststock::STATUS_COMPLETED => $this->__('Completed'),
                Magestore_Inventoryplus_Model_Adjuststock::STATUS_CANCELED => $this->__('Canceled'),
                Magestore_Inventoryplus_Model_Adjuststock::STATUS_PROCESSING => $this->__('Processing'),
            ),
        ...
        $this->addColumn('action', array(
            ...
            'renderer' => 'vendorsinventory/adjuststock_listadjuststock_renderer_action',
            'filter' => false,
            'sortable' => false,
            'index' => 'stores',
            'is_system' => true,
