...
class VES_VendorsInventory_Block_Purchaseorder_Returnorder_Tab_Returnorder extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function __construct() {
        ...
        if (($this->getPurchaseOrder() && $this->getPurchaseOrder()->getId()) || Mage::getModel('vendors/session')->getData('returnorder_product_import')) {
    ...
    protected function _prepareCollection() {
        ...
        $collection = Mage::getResourceModel('inventorypurchasing/product_collection')
                        ->getReturnCollection($purchaseorder_id, $productIds);
...
//                ->toOptionHash();
    ...
    public function _getSelectedProducts() {
        ...
        if (!is_array($products) || Mage::getModel('vendors/session')->getData('returnorder_product_import') || $this->getRequest()->getParam('id')) {
    ...
    public function getSelectedProducts() {
        ...
        if ($returnOrderProductImports = Mage::getModel('vendors/session')->getData('returnorder_product_import')) {
            ...
            foreach($productCollection as $product){    
                if(in_array($product->getWarehouseId(), $availableWarehouse)){
                    $result = $poProductWH->getQtyData($purchaseOrder->getId(), $product->getProductId(), $product->getWarehouseId());
    ...
    public function getWarehouseAvailable() {
        ...
        $warehouseAssigneds = Mage::getModel('vendorsinventory/permission')->getCollection()
                ->addFieldToFilter('vendors_id', $adminId)
        ;
        $warehouseIds = array();
