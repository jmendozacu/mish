 ...
 */
class VES_VendorsInventory_Block_Purchaseorder_Edit_Tab_Renderer_Purchasestatus extends Varien_Data_Form_Element_Select {
    /* Michael 201602 */
    ...
    public function getElementHtml() {
        ...
        $labels = Mage::helper('vendorsinventory/purchaseorder')->getReturnOrderStatus();
        $html = '<strong>';
        $html .= $labels[$value];
        $html.= '</strong>';
        return $html;
