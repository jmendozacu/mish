 ...
 */
class VES_VendorsInventory_Block_Purchaseorder_New_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {

    protected function _prepareLayout() {
        if (count(Mage::helper('vendorsinventory/purchaseorder')->getWarehouseOption()) > 0) {
    ...
    protected function _prepareForm() {
        ...
        $this->setForm($form);
        if (count(Mage::helper('vendorsinventory/purchaseorder')->getWarehouseOption()) <= 0) { // Add by Magnus
        ...
        $fieldset->addField('supplier_id', 'select', array(
            ...
            'name' => 'supplier_id',
            'disabled' => false,
            'values' => Mage::helper('vendorsinventory/supplier')->returnArrAllRowOfcolumnOftableSupplier('supplier_name'),
        ...
        if (Mage::helper('core')->isModuleEnabled('Magestore_Inventorywarehouse')) {
            $fieldset->addField('warehouse_ids', 'multiselect', array(
                ...
                'disabled' => false,
                'required' => true,
                'values' => Mage::helper('vendorsinventory/purchaseorder')->getWarehouseOption(),
            ));
        } else {
