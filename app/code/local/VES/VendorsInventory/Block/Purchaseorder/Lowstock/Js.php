 ...
 */
class VES_VendorsInventory_Block_Purchaseorder_Lowstock_Js extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function getCreatePOUrl() {
        return $this->getUrl('vendors/inventory_lowstock/createpo', array('_secure' => true));
    }

    public function getChangeSupplierUrl() {
        return $this->getUrl('vendors/inventory_lowstock/changesupplier', array('_secure' => true));
    }
