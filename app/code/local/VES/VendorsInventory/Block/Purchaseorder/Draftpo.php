 ...
 */
class VES_VendorsInventory_Block_Purchaseorder_Draftpo extends Mage_Adminhtml_Block_Widget {
    ...
    public function getBackUrl() {
        ...
        $backUrl = $this->getUrl('vendors/inventory_pendingorder/index', array($this->getRequest()->getParams()));
        if ($type == Magestore_Inventorypurchasing_Model_Purchaseorder_Draftpo::SUPPLYNEED_TYPE)
            $backUrl = $this->getUrl('vendors/inventory_inventorysupplyneeds/index', array($this->getRequest()->getParams()));
        if ($type == Magestore_Inventorypurchasing_Model_Purchaseorder_Draftpo::LOWSTOCK_TYPE)
            $backUrl = $this->getUrl('vendors/inventory_lowstock/index', array($this->getRequest()->getParams()));
    ...
    public function getMassChangeSupplierUrl($type) {
        return $this->getUrl('vendors/inventory_draftpo/masschangesupplier', array('id' => $this->getDraftPOId(),
                    'type' => $type,
        ));
    }
