 ...
 */
class VES_VendorsInventory_Helper_Draftpo extends Mage_Core_Helper_Abstract {
    ...
    public function getDraftPO() {
        $collection = Mage::getResourceModel('inventorypurchasing/purchaseorder_draftpo_collection');
//        $data = $collection->getData();
//        print_r($data);
//        echo $data['suppliers'];die;
        $vendorId = Mage::getSingleton('vendors/session')->getUser()->getId();
        $collection->getSelect()
                ->join( array('supplier'=> erp_inventory_supplier), "supplier.vendor_id=$vendorId", array('supplier.vendor_id'))
                ->where("main_table.suppliers='[\"supplier.supplier_id\"]'");
        echo $collection->getSelect();die;
        return $collection->setOrder('draft_po_id', 'DESC')
