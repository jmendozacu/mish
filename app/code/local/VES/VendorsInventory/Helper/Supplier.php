 ...
 */
class VES_VendorsInventory_Helper_Supplier extends Mage_Core_Helper_Abstract {

    public function importProduct($data) {
        if (count($data)) {
            Mage::getModel('vendors/session')->setData('supplier_product_import', $data);
        }
    }
    ...
    public function getSupplierInfoBySupplierId($supplierId) {
        ...
        $link = Mage::helper("adminhtml")->getUrl('vendors/inventory_supplier/edit', array('id' => $supplierId));
