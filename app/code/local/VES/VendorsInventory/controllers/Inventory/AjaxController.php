...
class VES_VendorsInventory_Inventory_AjaxController extends VES_Vendors_Controller_Action {
    ...
    public function saveAction() { //!!!!!!!!!!!!!!!!!!!!!
        ...
        $result = $this->_updateProductData(
                $productId, Mage::app()->getRequest()->getParam('field'), Mage::app()->getRequest()->getParam('value')
        );
...
//            );
    ...
    public function savesortingAction() {
        ...
        if (Mage::getStoreConfig('ampgrid/attr/byadmin')) {
            $extraKey = Mage::getSingleton('vendors/session')->getUser()->getId();
        }
