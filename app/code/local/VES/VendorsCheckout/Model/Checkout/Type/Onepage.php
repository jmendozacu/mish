 ...
 */
class VES_VendorsCheckout_Model_Checkout_Type_Onepage extends VES_VendorsCheckout_Model_Checkout_Type_Onepage_Amasty_Pure
{
	/**
     ...
     *
     * @return VES_VendorsCheckout_Model_Checkout_Type_Onepage_Amasty_Pure
     */
