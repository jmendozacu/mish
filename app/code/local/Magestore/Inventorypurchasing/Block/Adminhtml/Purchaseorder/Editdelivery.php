...
class Magestore_Inventorypurchasing_Block_Adminhtml_Purchaseorder_Editdelivery extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('back', 'onclick', 'setLocation(\''.$this->getUrl("adminhtml/inpu_purchaseorders/edit",array("id"=>$purchaseOrderId)).'\')');
        ...
        $this->_formScripts[] = "
            ...
            function uploadFile() {
                ...
                xhr.open('POST', '".$this->getUrl('adminhtml/inpu_purchaseorders/importproductforcreatedelivery')."');
                xhr.send(fd);
           }
