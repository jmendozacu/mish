...
class Magestore_Inventorypurchasing_Block_Adminhtml_Supplier_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
    ...
    public function __construct() {
        ...
        $this->_formScripts[] = "
            ...
            function uploadFile() {
                ...
                xhr.open('POST', '" . $this->getUrl('adminhtml/inpu_supplier/importproduct') . "');
                xhr.send(fd);
           }
           ...
           function showhistory(supplierHistoryId){
                var url = '" . $this->getUrl('adminhtml/inpu_supplier/showhistory') . "';               
    ...
    public function getHeaderText() {
        if (Mage::registry('inventorypurchasing_supplier_data')
            ...
            return Mage::helper('inventorypurchasing')->__("View Supplier '%s'", $this->htmlEscape(Mage::registry('inventorypurchasing_supplier_data')->getSupplierName())
            );
        }
