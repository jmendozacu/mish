 ...
 */
class Magestore_Inventoryplus_Model_Mysql4_Warehouse_Product_Collection extends Magestore_Inventoryplus_Model_Mysql4_Collection_Abstract {
    ...
    public function groupByProductId() {
        return $this->getSelect()->group('product_id');
    }
