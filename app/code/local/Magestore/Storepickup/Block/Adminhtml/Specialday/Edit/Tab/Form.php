...
class Magestore_Storepickup_Block_Adminhtml_Specialday_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('store_id', 'multiselect', array(
            ...
            'note'  => Mage::helper('storepickup')->__('Select stores applied special day(s)'),
        ));

        $fieldset->addField('date', 'date', array(
            'label' => Mage::helper('storepickup')->__('From Date'),
            'required' => true,
            'format' => 'yyyy-MM-dd',
        ...
        $fieldset->addField('specialday_date_to', 'date', array(
            'label' => Mage::helper('storepickup')->__('To Date'),
            'required' => true,
            'format' => 'yyyy-MM-dd',
            'image' => $image_calendar,
        ...
        $fieldset->addField('specialday_time_open', 'note', array(
            'label' => Mage::helper('storepickup')->__('Open Time'),
        ...
        $fieldset->addField('specialday_time_close', 'note', array(
            'label' => Mage::helper('storepickup')->__('Close Time'),
