<?php
class Mish_Shipit_Block_Checkout_Onepage_Shipping_Method_Available extends VES_VendorsShipping_Block_Checkout_Onepage_Shipping_Method_Available {
