...
class Bluethink_Quesanswer_Block_Vendors_Quesanswer_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
       ...
       $this->addColumn('question', array(
        ...
        $this->addColumn('answer', array(
         ...
         $this->addColumn('status', array(
          ...
          'align'     =>'left',
          'index'     => 'status',
          'renderer' => 'Bluethink_Quesanswer_Block_Vendors_Quesanswer_Grid_Renderer_Status',
      ));
