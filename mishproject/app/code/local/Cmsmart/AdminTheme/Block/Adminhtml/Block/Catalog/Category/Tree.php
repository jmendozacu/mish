 ...
 */
class Cmsmart_AdminTheme_Block_Adminhtml_Block_Catalog_Category_Tree extends Cmsmart_AdminTheme_Block_Adminhtml_Block_Catalog_Category_Tree_Amasty_Pure
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild('add_sub_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    'label'     => Mage::helper('catalog')->__('Subcategory'),
        ...
        if ($this->canAddRootCategory()) {
            $this->setChild('add_root_button',
                $this->getLayout()->createBlock('adminhtml/widget_button')
                    ->setData(array(
                        'label'     => Mage::helper('catalog')->__('Root Category'),
