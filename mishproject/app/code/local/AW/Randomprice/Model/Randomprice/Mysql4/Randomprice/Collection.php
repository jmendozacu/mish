...
class AW_Randomprice_Model_Randomprice_Mysql4_Randomprice_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
    ...
    public function addIdFilter($id) {
        $this->getSelect()->where('randompriceid = ?', $id);
        return $this;
    }
     ...
     * @param $stores
     * @return AW_Randomprice_Model_Mysql4_Blocks_Collection
     */
