...
* @Class        Chweb_Mullayernav_Helper_Data   
*/
class Chweb_Mullayernav_Helper_Data extends Mage_Core_Helper_Abstract {

    protected $_params = null;
    protected $_continueShoppingUrl = null;

    const XML_PATH_CAT_STYLE = 'mullayernav/mullayernav/cat_style';
    const XML_PATH_REMOVE_LINKS = 'mullayernav/mullayernav/remove_links';
    const XML_PATH_RESET_FILTERS = 'mullayernav/mullayernav/reset_filters';
     const CONFIG_PREFIX = 'mullayernav/settings/';
    ...
    public function wrapProducts($html) {
        ...
        $loaderHtml = '<div class="chweb_loading_filters" style="display:none"><img id="loading-image" src="' . Mage::getDesign()->getSkinUrl('images/chweb/ajax-loader.gif') . '" /></div>';
        $html .= $loaderHtml;
        ...
        if (Mage::app()->getRequest()->isXmlHttpRequest()) {
            ...
            $html = '<div id="chweb_layered_container">'
                    . $html
                    . '</div>'
                    . '';
        }
    ...
    public function getParams($asString = false, $without = null) {
        if (is_null($this->_params)) {
            ...
            $nCurrentPriceStyle = Mage::getStoreConfig('mullayernav/mullayernav/price_style');
