...
* @Class        Chweb_Mullayernav_Model_Layer_Filter_Price   
*/

    class Chweb_Mullayernav_Model_Layer_Filter_Price extends Mage_Catalog_Model_Layer_Filter_Price
    {
        ...
        {
            $data = array();   
            $style = Mage::getStoreConfig('mullayernav/mullayernav/price_style'); 
            if ('default' == $style)
            {
        ...
        protected function _getCacheKey()
        {
            ...
            $key .= Mage::getStoreConfig('mullayernav/mullayernav/price_style');
            $key .= Mage::helper('mullayernav')->getCacheKey('price');
            return $key;
        }   
        ...
        public function apply(Zend_Controller_Request_Abstract $request, $filterBlock)
        {
            ...
            if ('default' == Mage::getStoreConfig('mullayernav/mullayernav/price_style'))
            {
