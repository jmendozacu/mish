...
* @Class        Chweb_Mullayernav_Model_Layer_Filter_Attribute   
*/ 
class Chweb_Mullayernav_Model_Layer_Filter_Attribute extends Mage_Catalog_Model_Layer_Filter_Attribute
{
    ...
    protected function _getItemsData()
    {
        ...
        if ($data === null) {
            ...
            $currentIds = Mage::helper('mullayernav')->getParam($attribute->getAttributeCode());
            $tags = array(
    ...
    protected function _getBaseCollectionSql()
    {
		...
		//echo 'kk='.Mage::registry('chweb_rating_filter');die;
		$baseSelect->reset(Zend_Db_Select::GROUP);
