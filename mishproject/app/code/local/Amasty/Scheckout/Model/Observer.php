    ...
    protected function _initQuote(){
        ...
        if ($this->customerHasAddresses()){
                ...
                if ($this->getCustomer()->getPrimaryBillingAddress())
                    $quote->getBillingAddress()->importCustomerAddress($this->getCustomer()->getPrimaryBillingAddress())->setSaveInAddressBook(0);

                if ($this->getCustomer()->getPrimaryShippingAddress())
                    $quote->getShippingAddress()->importCustomerAddress($this->getCustomer()->getPrimaryShippingAddress())->setSaveInAddressBook(0);
