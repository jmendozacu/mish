...
class Amasty_Promocopy_Promo_QuoteController extends VES_Vendors_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        $data = Mage::getSingleton('vendors/session')->getPageData(true);
        if (!empty($data)) {
            $model->addData($data);
        }
        ...
        $this->_initAction()->getLayout()->getBlock('promo_quote_edit')
             ->setData('action', mage::getUrl('vendors/promo_quote/save'));
