...
class Magestore_Inventoryreports_Block_Adminhtml_Reportcontent_Reportbywarehouse_Grid_Numberofproductadjuststock extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        if(!$requestData['warehouse_select']){  //ALL WAREHOUSE
            ...
            $collection->addDistinct('main_table.product_id');
            $collection->joinLeft(array('adjust'=>$resource->getTableName('inventoryplus/adjuststock')), 'main_table.adjuststock_id = adjust.adjuststock_id', array('main_table.product_id'))
