<?php
class Magestore_Magenotification_Block_Adminhtml_Notification_Window extends Magestore_Magenotification_Block_Adminhtml_Notification_Window_Amasty_Pure{
