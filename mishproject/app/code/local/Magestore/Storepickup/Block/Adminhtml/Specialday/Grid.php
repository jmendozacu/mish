...
class Magestore_Storepickup_Block_Adminhtml_Specialday_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('date', array(
            'header' => Mage::helper('storepickup')->__('From Date'),
            'align' => 'left',
            'width' => '200',
            'type' => 'date',
            'format' => 'F',
        ...
        $this->addColumn('specialday_date_to ', array(
            'header' => Mage::helper('storepickup')->__('To Date'),
            'align' => 'left',
            'width' => '200',
            'type' => 'date',
            'format' => 'F',
        ...
        $this->addColumn('specialday_time_open', array(
            'header' => Mage::helper('storepickup')->__('Open Time'),
            'align' => 'left',
            'index' => 'specialday_time_open',
        ));

        $this->addColumn('specialday_time_close', array(
            'header' => Mage::helper('storepickup')->__('Close Time'),
            'align' => 'left',
