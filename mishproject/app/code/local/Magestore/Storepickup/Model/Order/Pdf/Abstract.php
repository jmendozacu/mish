<?php 
class Magestore_Storepickup_Model_Order_Pdf_Abstract extends Magestore_Storepickup_Model_Order_Pdf_Abstract_Amasty_Pure
{		
	/**
	...
	**/	
	...
	{	
        ...
        if (!$order->getIsVirtual()) {
			...
			$this->y-=$fix_i*10;
			if($fix_i==2) $size_image_hight = 615;
			try{
