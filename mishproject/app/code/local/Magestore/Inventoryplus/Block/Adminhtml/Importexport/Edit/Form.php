...
class Magestore_Inventoryplus_Block_Adminhtml_Importexport_Edit_Form extends Mage_ImportExport_Block_Adminhtml_Import_Edit_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(Mage_ImportExport_Model_Import::FIELD_NAME_SOURCE_FILE, 'file', array(
            ...
            'required' => true,
			'note' => 'You need to add more fields into CSV file is as follows:
							<b>warehouse_1,warehouse_2,suppliers,</b>...
						warehouse_1:  Available qty updating for warehouse ID equal 1<br/>
						warehouse_2:  Available qty updating for warehouse ID equal 2<br/>
						suppliers: List suppliers for this products example "1,2,3"<br/>'
        ));
