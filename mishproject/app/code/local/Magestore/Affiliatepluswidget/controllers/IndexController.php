...
class Magestore_Affiliatepluswidget_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    public function codeAction(){
    	...
    	$html = Mage::helper('affiliatepluswidget')->__('Copy and paste the HTML code onto your webpage.').'<br />';
    	$code = Mage::helper('affiliatepluswidget')->getWidgetCode($this->getRequest()->getParams());
    	$html .= sprintf('<textarea class= "widgets-code" onclick="this.select()" readonly cols="65" rows="13">%s</textarea>',$code);
