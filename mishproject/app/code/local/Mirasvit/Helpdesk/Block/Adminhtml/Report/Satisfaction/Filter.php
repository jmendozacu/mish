...
class Mirasvit_Helpdesk_Block_Adminhtml_Report_Satisfaction_Filter extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('report_type', 'select', array(
            'name'      => 'report_type',
            'options'   => array(
                'all'   => Mage::helper('reports')->__('Totals'),
                'by_user' => Mage::helper('reports')->__('By user'),
            ),
