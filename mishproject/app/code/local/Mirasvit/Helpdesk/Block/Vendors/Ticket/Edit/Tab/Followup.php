...
class Mirasvit_Helpdesk_Block_Vendors_Ticket_Edit_Tab_Followup extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        if (!$ticket->getFpIsRemind()) {
            $email = Mage::getSingleton('vendors/session')->getUser();
             /*if(Mage::getSingleton('vendors/session')->isLoggedIn()) {
     $email = Mage::getSingleton('vendors/session')->getUser()->getData()->getEmail();*/
