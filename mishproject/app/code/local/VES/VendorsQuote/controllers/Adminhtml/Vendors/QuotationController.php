<?php
class VES_VendorsQuote_Adminhtml_Vendors_QuotationController extends Mage_Adminhtml_Controller_Action
{
    protected function _isAllowed()
    {
        return Mage::getSingleton('admin/session')->isAllowed('admin/vendors/quotation');
    }
	public function indexAction(){
    	$this->loadLayout()
    		->_setActiveMenu('vendors')->_title($this->__('Quotations'))
    		->_addBreadcrumb(Mage::helper('vendorssales')->__('Vendors'), Mage::helper('vendorssales')->__('Vendors'))
	...
	public function sendQuoteMessageAction(){
	    ...
	    try{
	       ...
	       $message = $quote->addMessage(Mage::getSingleton('admin/session')->getUser()->getName(), $message,VES_VendorsQuote_Model_Quote_Message::TYPE_ADMIN, $isNotifyCustomer);
