...
class VES_VendorsQuote_Block_Vendor_Quote_View_Items_Column_Name_Bundle extends VES_VendorsQuote_Block_Vendor_Quote_View_Items_Column_Name
{
    /**
    ...
    public function getFormattedOption($values){
        if(is_array($values)){
            $result = '';
            foreach($values as $vl) {$result .=$vl;}
            $values = $result;
        }
        
        return parent::getFormattedOption($values);
    }
}