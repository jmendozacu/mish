 ...
 */
class VES_VendorsPriceComparison2_Block_Vendor_Selectandsell_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = new Varien_Data_Form(
            array('id' => 'edit_form', 'action' => $this->getUrl('vendors/pricecomparison/save'), 'method' => 'post')
        );
        ...
        $form->setValues(array('price'=>$model->getPrice()*1,'product_id'=>$model->getId()));
