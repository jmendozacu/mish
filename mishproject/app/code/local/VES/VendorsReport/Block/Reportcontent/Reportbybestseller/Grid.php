 ...
 */
class VES_VendorsReport_Block_Reportcontent_Reportbybestseller_Grid extends Magestore_Inventoryreports_Block_Adminhtml_Reportcontent_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection = Mage::helper('vendorsreport/bestseller')->getBestSellerProductCollection($requestData);
