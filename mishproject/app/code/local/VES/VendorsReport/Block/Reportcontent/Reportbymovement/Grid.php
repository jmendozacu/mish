 ...
 */
class VES_VendorsReport_Block_Reportcontent_Reportbymovement_Grid extends Magestore_Inventoryreports_Block_Adminhtml_Reportcontent_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('action', array(
            ...
            'index' => 'stores',
            'is_system' => true,
            'renderer' => 'vendorsreport/reportcontent_reportbymovement_renderer_action'
        ));
    ...
    public function getGridUrl() {
        return $this->getUrl('vendors/report_report/reportmovementgrid', array('type_id' => 'stockmovement', 'top_filter' => $this->getRequest()->getParam('top_filter')));
    }
