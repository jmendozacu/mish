 ...
 */
class VES_VendorsReport_Block_Reportcontent_Purchaseorder_Renderer_Action extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        $orderUrl = Mage::helper("adminhtml")
                ->getUrl('vendors/report_report/purchaseorderlist', array('top_filter' => $filter,
