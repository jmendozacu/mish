 ...
 */
class VES_VendorsReport_Block_Reportcontent_Purchaseorder_Grid extends Magestore_Inventoryreports_Block_Adminhtml_Reportcontent_Grid {
    ...
    protected function _prepareColumns() {
        ...
        */
        ...
        $this->addColumn('sales_ratio', array(
            ...
            'sortable' => false,
            'width' => '50px',
            'renderer' => 'vendorsreport/reportcontent_purchaseorder_renderer_salesratio'
        ));

        $this->_addWarehouseCoulmn('vendorsreport/reportcontent_purchaseorder_renderer_warehouse');
        ...
        $this->addColumn('action', array(
            ...
            'index' => 'stores',
            'is_system' => true,
            'renderer' => 'vendorsreport/reportcontent_purchaseorder_renderer_action'
        ));
    ...
    public function getTotals() {
        ...
        //calculate ratio
        $renderer = $this->getLayout()->createBlock('vendorsreport/reportcontent_purchaseorder_renderer_salesratio');
