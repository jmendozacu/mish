 ...
 */
class VES_VendorsReport_Block_Reportcontent_Reportbystockonhand_Grid_Moststockremain extends VES_VendorsReport_Block_Reportcontent_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection = Mage::helper('vendorsreport/stockonhand')->getStockRemainingCollection($requestData);
    ...
    protected function _prepareColumns() {
        ...
        */
        ...
        $this->_addWarehouseCoulmn('vendorsreport/reportcontent_reportbystockonhand_renderer_warehouse');
        ...
        $this->addColumn('action', array(
            ...
            'index' => 'stores',
            'is_system' => true,
            'renderer' => 'vendorsreport/reportcontent_reportbystockonhand_renderer_action'
        ));
    ...
    public function getGridUrl() {
        return $this->getUrl('vendors/report_report/stockonhandmoststockremaingrid', array('type_id' => 'stockonhand', 'top_filter' => $this->getRequest()->getParam('top_filter')));
    }
