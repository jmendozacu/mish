 ...
 */
class VES_VendorsReport_Block_Reportcontent_Reportbycustomer_Grid extends Magestore_Inventoryreports_Block_Adminhtml_Reportcontent_Grid {
    ...
    protected function _prepareCollection() {
        $collection = Mage::helper('vendorsreport/customer')->getCustomerReportCollection($this->_requestData);
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('action', array(
            ...
            'index' => 'stores',
            'is_system' => true,
            'renderer' => 'vendorsreport/reportcontent_reportbycustomer_renderer_action'
        ));
    ...
    public function getGridUrl() {
        return $this->getUrl('vendors/report_report/reportcustomergrid', array('type_id' => 'customer', 'top_filter' => $this->getRequest()->getParam('top_filter')));
    }
