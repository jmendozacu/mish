 ...
 */
class VES_VendorsReport_Block_Vendor_Report_Sales_Grid extends Mage_Adminhtml_Block_Report_Sales_Sales_Grid
{
    ...
    public function getResourceCollectionName()
    {
        return ($this->getFilterData()->getData('report_type') == 'updated_at_order')
            ...
            : 'vendorsreport/order_collection';
    }

	public function getCollection()
    {
        if (is_null($this->_collection)) {
            $this->setCollection(Mage::getModel('vendorsreport/grouped_collection'));
        }
