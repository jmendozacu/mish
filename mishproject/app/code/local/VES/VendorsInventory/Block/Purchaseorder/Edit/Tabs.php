 ...
 */
class VES_VendorsInventory_Block_Purchaseorder_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
    ...
    protected function _beforeToHtml() {
        ...
        $this->addTab('form_section', array(
            ...
            'content' => $this->getNoticeText() .
                    $this->getLayout()
                    ->createBlock('vendorsinventory/purchaseorder_edit_tab_form')
                    ->toHtml(),
        ));
