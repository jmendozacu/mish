...
class VES_VendorsInventory_Block_Purchaseorder_Edit_Tab_History extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('field_change', array(
            ...
            'renderer' => 'vendorsinventory/purchaseorder_edit_tab_renderer_fieldchanged',
        ...
        $this->addColumn('show_history', array(
            ...
            'filter' => false,
            'sortable' => false,
            'renderer' => 'vendorsinventory/purchaseorder_edit_tab_renderer_history'
        ));
