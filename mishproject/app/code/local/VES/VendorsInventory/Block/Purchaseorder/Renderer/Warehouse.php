 ...
 */
class VES_VendorsInventory_Block_Purchaseorder_Renderer_Warehouse extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        foreach($warehouseIds as $warehouseId){
            $url = Mage::helper('adminhtml')->getUrl('vendors/inventory_warehouse/edit',array('id'=>$warehouseId));
