 ...
 */
class VES_VendorsInventory_Block_Purchaseorder_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        if (Mage::getSingleton('vendors/session')->getPurchaseorderData()) {
            $data = Mage::getSingleton('vendors/session')->getPurchaseorderData();
            Mage::getSingleton('vendors/session')->setPurchaseorderData(null);
        ...
        $fieldset->addField('supplier_name', 'link', array(
            ...
            'name' => 'supplier_name',
            'style' => "color:blue",
            'href' => Mage::helper("adminhtml")->getUrl('vendors/inventory_supplier/edit', array('id' => Mage::helper('vendorsinventory/purchaseorder')->getDataByPurchaseOrderId($purchaseOrderId, 'supplier_id'))),
        ...
        $fieldset->addField('order_placed', 'select', array(
            ...
            'required' => true,
            'name' => 'order_placed',
            'values' => Mage::helper('vendorsinventory/purchaseorder')->getOrderPlaced(),
        ));
        ...
        $fieldset->addField('status', 'purchase_status', array(
            ...
            'name' => 'status',
            'values' => Mage::helper('vendorsinventory/purchaseorder')->getReturnOrderStatus(),
            'disabled' => $disabled,
        ));
    ...
    public function getWarehouse($warehouseIds) {
        ...
        foreach ($warehouseIds as $warehouseId) {
            $warehouseNames .= "<a href='" . Mage::helper("adminhtml")->getUrl('vendors/inventory_warehouse/edit', array('id' => $warehouseId)) . "'>" . Mage::getModel('inventoryplus/warehouse')->load($warehouseId)->getWarehouseName() . "</a><br />";
        }
