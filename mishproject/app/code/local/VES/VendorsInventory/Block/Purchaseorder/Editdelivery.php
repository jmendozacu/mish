 ...
 */
class VES_VendorsInventory_Block_Purchaseorder_Editdelivery extends Mage_Adminhtml_Block_Widget_Form_Container {
    ...
    public function __construct() {
        ...
        $this->_updateButton('back', 'onclick', 'setLocation(\'' . $this->getUrl("vendors/inventory_purchaseorders/edit", array("id" => $purchaseOrderId)) . '\')');
        ...
        $this->_formScripts[] = "
            ...
            function uploadFile() {
                ...
                xhr.open('POST', '" . $this->getUrl('vendors/inventory_purchaseorders/importproductforcreatedelivery') . "');
                xhr.send(fd);
           }
    ...
    public function getHeaderText() {
        if (Mage::registry('purchaseorder_data') && Mage::registry('purchaseorder_data')->getId()
            ...
            return Mage::helper('inventorypurchasing')->__("Create New Delivery For Purchase Order No. '%s'", $this->htmlEscape(Mage::registry('purchaseorder_data')->getId())
            );
        }
    }
