 ...
 */
class VES_VendorsInventory_Block_Purchaseorder_Draftpo_Renderer_Warehouseqty extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    protected function _canEdit() {
        $warehouseId = $this->getColumn()->getWarehouseId();
        return Mage::helper('vendorsinventory/adjuststock')->getPermission($warehouseId, 'can_purchase_product');
    }
