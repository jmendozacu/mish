<?php
class VES_VendorsInventory_Block_Physicalstocktaking_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        if($condorder){
            $condorder = Mage::helper('vendorsinventory')->filterDates($condorder,array('from','to'));
            $from = $condorder['from'];
            $to = $condorder['to'];
            if($from){
