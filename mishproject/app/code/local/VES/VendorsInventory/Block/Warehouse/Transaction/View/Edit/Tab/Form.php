 ...
 */
class VES_VendorsInventory_Block_Warehouse_Transaction_View_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {   
        ...
        $this->setForm($form);
        $data = '';
        if (Mage::getSingleton('vendors/session')->getTransactionData()) {
            $data = Mage::getSingleton('vendors/session')->getTransactionData();
            Mage::getSingleton('vendors/session')->setTransactionData(null);
