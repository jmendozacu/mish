 ...
 */
class VES_VendorsInventory_Block_Warehouse_Edit_Tab_Dashboard extends Mage_Adminhtml_Block_Template {
    ...
    protected function _prepareLayout() {
        ...
        $this->setTemplate('ves_vendorsinventory/warehouse/dashboard.phtml');
