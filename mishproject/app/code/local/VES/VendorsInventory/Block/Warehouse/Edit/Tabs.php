 ...
 */
class VES_VendorsInventory_Block_Warehouse_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
    ...
    protected function _beforeToHtml() {
        ...
        $username = $admin->getVendorId();
        $warehouse = Mage::registry('warehouse_data');
        //add top tabs into warehouse
        Mage::dispatchEvent('ves_vendorsinventory_add_top_tab_warehouse', array('tab' => $this, 'warehouse' => $warehouse));
        ...
        if (!$this->getRequest()->getParam('id')) {
            $this->addTab('form_section', array(
                ...
                'content' => $this->getLayout()
                        ->createBlock('vendorsinventory/warehouse_edit_tab_form')
                        ->toHtml(),
            ));
        }
        //warehouse products
        ...
        if (!$this->getRequest()->getParam('id')) {
            $this->addTab('permission_section', array(
                ...
                'content' => $this->getLayout()
                        ->createBlock('vendorsinventory/warehouse_edit_tab_permission')
                        ->toHtml(),
            ));
...
//                'content' => $this->getLayout()
//                        ->createBlock('vendorsinventory/warehouse_edit_tab_vendors')
//                        ->toHtml(),
//            )); 
        } else {
            $this->addTab('permission_section', array(
...
//            ));
        ...
        Mage::dispatchEvent('ves_vendorsinventory_add_tab_warehouse', array('tab' => $this, 'warehouse_id' => $this->getRequest()->getParam('id')));
