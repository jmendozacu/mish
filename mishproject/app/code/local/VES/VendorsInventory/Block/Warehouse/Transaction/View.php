 ...
 */
class VES_VendorsInventory_Block_Warehouse_Transaction_View extends Mage_Adminhtml_Block_Widget_Form_Container {
    ...
    public function __construct() {        
        ...
        $this->_updateButton('back', 'onclick', 'setLocation(\'' . $this->getUrl("vendors/inventory_warehouse/edit", array("id" => $warehouse_id)) . '\')');
