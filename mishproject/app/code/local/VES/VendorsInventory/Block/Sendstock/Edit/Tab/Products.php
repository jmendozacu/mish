 ...
 */
class VES_VendorsInventory_Block_Sendstock_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid {//implements Magestore_Inventoryplus_Block_Adminhtml_Barcode_Scan_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('product_location', array(
            ...
            'filter' => false,
            'sortable' => false,
            'renderer' => 'vendorsinventory/sendstock_renderer_proLocationSendstock'
        ));
    ...
    public function getSelectedProducts() {
        ...
        if ($sendStockProductImports = Mage::getModel('vendors/session')->getData('sendstock_product_import')) {
