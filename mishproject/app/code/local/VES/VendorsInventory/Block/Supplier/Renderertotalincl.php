 ...
 */
class VES_VendorsInventory_Block_Supplier_Renderertotalincl extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    public function render(Varien_Object $row)
    {
        ...
        $tax_rate = Mage::helper('vendorsinventory/purchaseorder')->getDataByPurchaseOrderId($purchaseOrderId,'tax_rate');        
