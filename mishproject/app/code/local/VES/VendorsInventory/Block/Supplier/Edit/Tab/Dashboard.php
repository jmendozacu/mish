 ...
 */
class VES_VendorsInventory_Block_Supplier_Edit_Tab_Dashboard extends Mage_Adminhtml_Block_Template {
    ...
    protected function getSalesData() {
        ...
        $saleOrderItemCol->addFieldToFilter('main_table.created_at', array(
                    'from' => Mage::helper('vendorsinventory/supplier')->getLast30DaysTime(),
                    'date' => true,
                ));
