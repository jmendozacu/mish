...
class VES_VendorsInventory_Block_Supplier_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function __construct() {
        ...
        if (($this->getSupplier() && $this->getSupplier()->getId()) || Mage::getModel('vendors/session')->getData('supplier_product_import')) {
    ...
    protected function _getSelectedProducts() {
        ...
        if (!is_array($products) || Mage::getModel('vendors/session')->getData('supplier_product_import')) {            
    ...
    public function getSelectedRelatedProducts() {
        ...
        if ($supplierProductImports = Mage::getModel('vendors/session')->getData('supplier_product_import')) {
