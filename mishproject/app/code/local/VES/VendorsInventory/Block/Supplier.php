 ...
 */
class VES_VendorsInventory_Block_Supplier extends Mage_Adminhtml_Block_Widget_Grid_Container {

    public function __construct() {
        $this->_controller = 'supplier';
        $this->_blockGroup = 'vendorsinventory';
        $this->_headerText = Mage::helper('vendorsinventory')->__('Manage Suppliers');
        $this->_addButtonLabel = Mage::helper('vendorsinventory')->__('Add Supplier');
        parent::__construct();
    } 
