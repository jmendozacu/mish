 ...
 */
class VES_VendorsInventory_Block_Inventoryphysicalstocktaking_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('form_section', array(
            ...
            'content'   => $this->getLayout()
                                ->createBlock('vendorsinventory/inventoryphysicalstocktaking_edit_tab_form')
                                ->toHtml(),
        ));
