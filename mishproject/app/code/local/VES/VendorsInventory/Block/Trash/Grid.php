...
class VES_VendorsInventory_Block_Trash_Grid extends Mage_Adminhtml_Block_Widget_Grid {
     ...
     *
     * @return Magestore_Inventory_Block_Adminhtml_Trash_Grid
     */
    protected function _prepareCollection() {
        ...
        $collection -> addFieldToFilter(
            'trash',
            array('eq' => Magestore_Inventorypurchasing_Model_Purchaseorder::IS_TRASH,
            )
        );
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('supplier_name', array(
            ...
            'align' => 'left',
            'index' => 'supplier_id',
            'options' => Mage::helper('vendorsinventory/supplier')->getAllSupplierName(),
        ...
        $this->addColumn('status', array(
            ...
            'index' => 'status',
            'type' => 'options',
            'options' => Mage::helper('vendorsinventory/purchaseorder')->getReturnOrderStatus(),
        ));
    ...
    protected function _prepareMassaction() {
        ...
        $this->getMassactionBlock()->addItem('recycle', array(
            'label' => Mage::helper('inventorypurchasing')->__('Restore'),
