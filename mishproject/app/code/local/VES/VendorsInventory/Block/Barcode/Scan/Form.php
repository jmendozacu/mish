...
abstract class VES_VendorsInventory_Block_Barcode_Scan_Form extends Mage_Adminhtml_Block_Template
{
    public function __construct() { 
        parent::__construct();
        $this->setTemplate('ves_vendorsinventory/barcode/scan/form.phtml');
        return $this;
    }
    ...
    public function getScanUrl() {
        return $this->getUrl('vendors/inventory_barcode/scan',  array(
                '_current' => true,
                '_secure' => true,
    ...
    public function getResetDataUrl() {
        return $this->getUrl('vendors/inventory_barcode/resetscan',  array(
                '_current' => true,
                '_secure' => true,
                'action' => $this->getScanActionName(),
            ));        
    ...
    public function getReUpdateQtyUrl() {
        return $this->getUrl('vendors/inventory_barcode/reupdateqty',  array(
            '_current' => true,
            '_secure' => true,
            'action' => $this->getScanActionName(),
        ));
    ...
    public function getReUpdateQtyManualUrl() {
        return $this->getUrl('vendors/inventory_barcode/reupdateqtymanual',  array(
            '_current' => true,
            '_secure' => true,
            'action' => $this->getScanActionName(),
        ));
