 ...
 */
class VES_VendorsInventory_Inventory_BarcodeController extends VES_Vendors_Controller_Action {
    ...
    protected function _initAction() {
        $this->loadLayout()
                ...
                ->_addBreadcrumb(
                        Mage::helper('adminhtml')->__('Manage Inventory'), Mage::helper('adminhtml')->__('Manage Barcodes')
        );
    ...
    public function scanAction() {
        $currentAdmin = Mage::getSingleton('vendors/session');
        $currentAdminId = $currentAdmin->getUser()->getId();
        $result = array();
        $notFound = false;
