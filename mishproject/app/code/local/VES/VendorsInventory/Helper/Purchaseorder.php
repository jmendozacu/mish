 ...
 */
class VES_VendorsInventory_Helper_Purchaseorder extends Mage_Core_Helper_Abstract {
...
//            Magestore_Inventorypurchasing_Model_Purchaseorder::WAITING_APPROVE_STATUS => Mage::helper('inventorypurchasing')->__('Waiting approve'),
    ...
    public function importProduct($data) {
        if (count($data)) {
            Mage::getModel('vendors/session')->setData('purchaseorder_product_import', $data);
        }
    }
    ...
    public function importDeliveryProduct($data) {
        if (count($data)) {
            Mage::getModel('vendors/session')->setData('delivery_purchaseorder_product_import', $data);
        }
    }

    public function importReturnOrderProduct($data) {
        if (count($data)) {
            Mage::getModel('vendors/session')->setData('returnorder_product_import', $data);
        }
    }
