 ...
 */
class VES_VendorsInventory_Helper_Lowstock extends Mage_Core_Helper_Abstract {
    ...
    public function getCurrentSupplierIds() {
        ...
        if (!is_array($supplierIds)) {
            $supplierIds = Mage::getSingleton('vendors/session')->getData('currrent_supplier_ids');
        } else {
            Mage::getSingleton('vendors/session')->setData('currrent_supplier_ids', $supplierIds);
        }
    ...
    public function getCurrentWarehouseIds() {
        ...
        if (!is_array($warehouseIds)) {
            $warehouseIds = Mage::getSingleton('vendors/session')->getData('currrent_warehouse_ids');
        } else {
            Mage::getSingleton('vendors/session')->setData('currrent_warehouse_ids', $warehouseIds);
        }
