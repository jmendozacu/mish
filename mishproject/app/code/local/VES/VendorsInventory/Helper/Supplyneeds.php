 ...
 */
class VES_VendorsInventory_Helper_Supplyneeds extends Mage_Core_Helper_Abstract {
    ...
    public function getWarehouseSelected() {
        ...
        $warehousesEnable = Mage::helper('vendorsinventory/warehouse')->getAllWarehouseNameEnable();
    ...
    public function getsupplierSelected() {
        ...
        $suppliersEnable = Mage::getModel('inventorypurchasing/supplier')->getCollection()
                ->addFieldToFilter('vendor_id',$vendorId);  //supplyneed plugin depends on purchasing
    ...
    public function calculateWarehouseQty(&$productData) {
        $gridExport = Mage::getBlockSingleton('vendorsinventory/inventorysupplyneeds_gridexport');
        $collection = $gridExport->getCollectionData(array_keys($productData));
        $warehouses = $this->getWarehouseSelected();
        $primaryWarehouse = Mage::helper('vendorsinventory/warehouse')->getPrimaryWarehouse();
        if (count($collection)) {
    ...
    public function getDraftPO() {
        return Mage::helper('vendorsinventory/draftpo')->getDraftPO();
    }
