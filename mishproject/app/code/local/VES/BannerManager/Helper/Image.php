<?php
class VES_BannerManager_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('bannermanager/image'));
        $this->keepTransparency(false);
        $this->setImageFile($imageFile);
        $this->backgroundColor(212,211,211);
        return $this;
    }
