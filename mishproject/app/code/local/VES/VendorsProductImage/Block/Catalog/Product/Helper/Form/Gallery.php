...
class VES_VendorsProductImage_Block_Catalog_Product_Helper_Form_Gallery extends Mage_Adminhtml_Block_Catalog_Product_Helper_Form_Gallery
{
    ...
    public function getContentHtml()
    {
        ...
        $content = Mage::getSingleton('core/layout')
            ->createBlock('vendorsproductimage/catalog_product_helper_form_gallery_content');
