...
class VES_VendorsProduct_Block_Adminhtml_Notification extends Mage_Adminhtml_Block_Template
{
	...
	public function getMessage(){
	    ...
	    if($productCount == 1)return $this->__('There is %s product awaiting for approval. <a href="%s">Click Here</a> to review them.','<strong>'.$productCount.'</strong>',$this->getUrl('*/vendors_catalog_product/pending'));
	    return $this->__('There are %s products awaiting for approval. <a href="%s">Click Here</a> to review them.','<strong>'.$productCount.'</strong>',$this->getUrl('*/vendors_catalog_product/pending'));
	}
