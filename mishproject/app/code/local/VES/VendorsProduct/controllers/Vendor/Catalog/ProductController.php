...

{
...

    {
    	...
    	$this->_addBreadcrumb(Mage::helper('vendors')->__('Manage Products'), Mage::helper('vendors')->__('Manage Products'));
...

    {
        ...
        if ($this->getRequest()->getParam('popup')) {
            ...
            $this->_addBreadcrumb(Mage::helper('vendors')->__('Catalog'), Mage::helper('vendors')->__('Catalog'))
            	...
            	->_addBreadcrumb(Mage::helper('vendors')->__('Manage Products'), Mage::helper('vendors')->__('Manage Products'),Mage::getUrl('vendors/catalog_product'))

            	->_addBreadcrumb(Mage::helper('vendors')->__('New Product'), Mage::helper('vendors')->__('New Product'));
...

    {
		...
		$this->_addBreadcrumb(Mage::helper('vendors')->__('Catalog'), Mage::helper('vendors')->__('Catalog'))
            	...
            	->_addBreadcrumb(Mage::helper('vendors')->__('Edit Product'), Mage::helper('vendors')->__('Edit Product'));
...
//            }
...

    {
		...
		/* echo "product controller outside";
        exit;*/
        ...
        if ($data) {
          ...
          //  Mage::app()->getStore()->setId($currentStoreId);
            ...
            try {
				...
				//Mage::app()->setCurrentStore(Mage_Core_Model_App::ADMIN_STORE_ID);
                $product->setCategoryIds($data[parentcategory]);
                $product->save();
