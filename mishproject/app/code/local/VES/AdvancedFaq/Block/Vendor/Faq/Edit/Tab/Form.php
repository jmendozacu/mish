...
class OTTO_AdvancedFaq_Block_Seller_Faq_Edit_Tab_Form extends OTTO_AdvancedFaq_Block_Adminhtml_Faq_Edit_Tab_Form
{
	protected function _prepareForm()
	{
		...
		$fieldset->addField('category_id', 'select', array(
				...
				'required'  => true,
				'name'      => 'category_id',
				'values'    => Mage::getModel('advancedfaq/faq')->getCategoryOptionsSellers(),
		));
		...
		*/
		...
		if ( Mage::getSingleton('sellers/session')->getFaqData() )
		{
			$form->setValues(Mage::getSingleton('sellers/session')->getFaqData());
			Mage::getSingleton('sellers/session')->setFaqData(null);
