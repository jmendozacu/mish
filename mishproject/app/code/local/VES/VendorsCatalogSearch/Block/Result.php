 ...
 * @module     Catalog
 */
class VES_VendorsCatalogSearch_Block_Result extends Mage_Core_Block_Template
{
    /**
    ...
    protected function _prepareLayout()
    {
    	...
    	$canShowBreadCrumbs = Mage::helper('vendorsconfig')->getVendorConfig('catalogsearch/config/show_breadcrumbs',$vendorId);
    	if($canShowBreadCrumbs){
	        ...
	        if ($breadcrumbs) {
	            ...
	            $breadcrumbs->addCrumb('vendor_home', array(
	                'label'	=>Mage::registry('vendor')->getTitle(),
	                'title'	=>Mage::registry('vendor')->getTitle(),
	                'link'	=>Mage::helper('vendorspage')->getUrl('',Mage::registry('vendor')->getVendorId()),
		...
		$pageLayout = Mage::helper('vendorsconfig')->getVendorConfig('catalogsearch/config/layout',$vendorId);
		switch($pageLayout){
            	case 'empty';
        ...
        $this->getLayout()->getBlock('root')->setTemplate('page/'.$template);
...
//           ->setCollection($this->_getProductCollection());
    ...
    protected function _getProductCollection()
    {
        ...
        $this->_productCollection->addAttributeToFilter('vendor_id',array('eq'=>Mage::registry('vendor')->getId()));
