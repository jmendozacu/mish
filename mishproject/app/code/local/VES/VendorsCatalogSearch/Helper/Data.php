 ...
 */
class VES_VendorsCatalogSearch_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    {
    	$colecltion = $this->getQuery()->getSuggestCollection();
    	//$colecltion->addAttributeToFilter('vendor_id',array('eq'=>Mage::registry('vendor_id')));
        return $colecltion;
    }
    ...
    public function getResultUrl($query = null)
    {
        ...
        $url= Mage::getUrl($current_url_key."/".Mage::registry('vendor_id').'/searchresult', array(
            '_query' => array(self::QUERY_VAR_NAME => $query),
            '_secure' => Mage::app()->getFrontController()->getRequest()->isSecure()
        ));
        
    //	$url = Mage::getBaseUrl().$current_url_key."/".Mage::registry('vendor_id').'/catalogsearch/result';
    	return $url;
    }
    ...
    {
    	$current_url_key = Mage::getStoreConfig('vendors/vendor_page/url_key');
        return $this->_getUrl($current_url_key."/".Mage::registry('vendor_id').'/ajaxsearch', array(
            '_secure' => Mage::app()->getFrontController()->getRequest()->isSecure()
        ));
    }
