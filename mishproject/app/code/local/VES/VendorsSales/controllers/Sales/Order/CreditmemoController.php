...
class VES_VendorsSales_Sales_Order_CreditmemoController extends VES_Vendors_Controller_Action
{
    /**
    ...
    public function viewAction()
    {
        ...
        if ($creditmemo) {
            ...
            ->_addBreadcrumb($this->__('Credit Memos'), $this->__('Orders'),Mage::getUrl('vendors/sales_creditmemo'))
            ->_addBreadcrumb($this->__('View Credit Memo'), $this->__('View Credit Memo'));
    ...
    public function newAction()
    {
        if ($creditmemo = $this->_initCreditmemo()) {
            ...
            $this->loadLayout()
                ...
                ->_addBreadcrumb($this->__('Sales'), $this->__('Sales'))
                ->_addBreadcrumb($this->__('Orders'), $this->__('Orders'),Mage::getUrl('vendors/sales_order_creditmemo'))
                ->_addBreadcrumb($this->__('View Order'), $this->__('View Order'),Mage::getUrl('vendors/sales_order_creditmemo/view',array('order_id'=>$creditmemo->getOrderId())))
                ->_addBreadcrumb($this->__('New Credit Memo'), $this->__("New Credit Memo"))
                ->renderLayout();
        } else {
            $this->_forward('noRoute');
        }
