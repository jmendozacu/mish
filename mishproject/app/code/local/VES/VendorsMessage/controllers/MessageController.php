<?php
class VES_VendorsMessage_MessageController extends VES_Vendors_Controller_Action
{
	protected function _isAllowed()
    {
        return Mage::helper('vendorsmessage')->moduleEnable();
    }
	...
	public function preDispatch(){
		...
		if(!Mage::registry('message_box')){
			$messageBox = Mage::helper('vendorsmessage')->getMsgboxByAccount($this->_getSession()->getVendorId(),VES_VendorsMessage_Model_Message::TYPE_VENDOR);
    ...
    {
    	$messageCount = Mage::helper('vendorsmessage')->getUnreadMessageCount($this->_getSession()->getVendorId(), VES_VendorsMessage_Model_Message::TYPE_VENDOR);
    ...
    public function saveAction(){
    	try{
			...
			$id = $this->_getSession()->getVendor()->getVendorId();
