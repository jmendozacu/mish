...
class Mercadolibre_Items_Block_Adminhtml_Itemdetailprofile_Edit_Tab_Formfooter extends Mage_Adminhtml_Block_Widget_Form
{
  ...
  protected function _prepareForm()
  {
	  ...
	  $wysiwygConfig = Mage::getSingleton('cms/wysiwyg_config')->getConfig(
		...
		$contentField = $fieldset->addField('description_footer', 'editor', array(
