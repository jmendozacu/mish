...
class Mercadolibre_Items_Block_Adminhtml_Itemdetailprofile_Edit_Tab_Formbody extends Mage_Adminhtml_Block_Widget_Form
{
  ...
  protected function _prepareForm()
  {
      ...
      $contentField = $fieldset->addField('description_body', 'editor', array(
