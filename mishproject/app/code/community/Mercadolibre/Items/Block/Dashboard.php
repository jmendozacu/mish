<?php
class Mercadolibre_Items_Block_Dashboard extends Mage_Core_Block_Template
{
    protected $_locale;
    ...
    protected function _prepareLayout()
    {
		...
		$this->setChild('questionstatus',
                $this->getLayout()->createBlock('adminhtml/dashboard_questionstatus')
        );
		
		$this->setChild('orderstatus',
                $this->getLayout()->createBlock('adminhtml/dashboard_orderstatus')
        );
