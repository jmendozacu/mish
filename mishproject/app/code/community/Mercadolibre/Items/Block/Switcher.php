<?php
class Mercadolibre_Items_Block_Switcher extends Mage_Adminhtml_Block_Template
{
    /**
     * Key in config for store switcher hint
     */
    const XPATH_HINT_KEY = 'switcher';
    ...
    public function __construct()
    {
	    ...
	    parent::__construct();
        $this->setTemplate('items/mapping/switcher.phtml');
