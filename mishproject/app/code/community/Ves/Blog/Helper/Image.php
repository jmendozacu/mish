 ...
 */
class Ves_Blog_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('ves_blog/banner_image'));
     ...
     *
     * @see ves_blog_Model_Banner_Image
     * @param int $width
     * @param int $height
     * @return ves_blog_Helper_Image
     */
     ...
     * Enter description here...
     *
     * @return ves_blog_Model_Banner_Image
     */
