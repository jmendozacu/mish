 ...
 */
class Ves_Optimize_Model_Container_Sidebar_Poll extends Ves_Optimize_Model_Container_Abstract
{
    /**
     * Current Poll id
     */
    ...
    {
        $visitor = $this->_getCookieValue(Ves_Optimize_Model_Cookie::COOKIE_CUSTOMER, '');
        if (!$visitor) {
    ...
    protected function _getPollToShow()
    {
        if ($this->_activePollId === null) {
            ...
            //filter voted
            $voted = $this->_getCookieValue(Ves_Optimize_Model_Cookie::COOKIE_POLL, '');
            if ($voted
