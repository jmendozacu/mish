 ...
 */
abstract class Ves_Optimize_Model_Container_Abstract
{
    /**
     * @var null|Ves_Optimize_Model_Processor
     */
     ...
     *
     * @var Ves_Optimize_Model_Container_Placeholder
     */
     ...
     * Class constructor
     *
     * @param Ves_Optimize_Model_Container_Placeholder $placeholder
     */
    ...
    public function applyInApp(&$content)
    {
        ...
        if (Mage::getStoreConfig(Ves_Optimize_Model_Processor::XML_PATH_CACHE_DEBUG)) {
            $debugBlock = new Ves_Optimize_Block_Debug();
    ...
    {
        return Ves_Optimize_Model_Cache::getCacheInstance()->load($id);
    }
     ...
     * @return Ves_Optimize_Model_Container_Abstract
     */
    public function setProcessor(Ves_Optimize_Model_Processor $processor)
    {
    ...
    protected function _getCategoryId()
    {
        if ($this->_processor) {
            $categoryId = $this->_processor
                ->getMetadata(Ves_Optimize_Model_Processor_Category::METADATA_CATEGORY_ID);
            if ($categoryId) {
                return $categoryId;
            }
        }
        ...
        return $this->_getCookieValue(Ves_Optimize_Model_Cookie::COOKIE_CATEGORY_ID, null);
    }
    ...
    protected function _getProductId()
    {
        ...
        return $this->_processor->getMetadata(Ves_Optimize_Model_Processor_Product::METADATA_PRODUCT_ID);
    }
