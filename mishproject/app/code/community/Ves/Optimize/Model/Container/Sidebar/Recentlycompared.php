 ...
 */
class Ves_Optimize_Model_Container_Sidebar_Recentlycompared
    extends Ves_Optimize_Model_Container_Abstract
{
    ...
    {
        return $this->_getCookieValue(Ves_Optimize_Model_Cookie::COOKIE_RECENTLY_COMPARED, '')
            . $this->_getCookieValue(Ves_Optimize_Model_Cookie::COOKIE_CUSTOMER, '');
    }
