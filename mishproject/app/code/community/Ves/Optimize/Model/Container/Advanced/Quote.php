 ...
 */
abstract class Ves_Optimize_Model_Container_Advanced_Quote
    extends Ves_Optimize_Model_Container_Advanced_Abstract
{
    /**
     * Cache tag prefix
     */
    ...
    {
        $cookieCart = Ves_Optimize_Model_Cookie::COOKIE_CART;
        $cookieCustomer = Ves_Optimize_Model_Cookie::COOKIE_CUSTOMER;
        return md5(Ves_Optimize_Model_Container_Advanced_Quote::CACHE_TAG_PREFIX
