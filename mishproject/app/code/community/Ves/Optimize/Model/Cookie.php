 ...
 */
class Ves_Optimize_Model_Cookie extends Mage_Core_Model_Cookie
{
    /**
     * Cookie names
     */
    ...
    protected function _getSalt()
    {
        if ($this->_salt === null) {
            ...
            if (!$this->_salt) {
                ...
                Ves_Optimize_Model_Cache::getCacheInstance()->save($this->_salt, $saltCacheId,
    ...
    public static function registerViewedProducts($productIds, $countLimit, $append = true)
    {
        ...
        if ($append) {
            if (!empty($_COOKIE[Ves_Optimize_Model_Container_Viewedproducts::COOKIE_NAME])) {
                $cookieIds = $_COOKIE[Ves_Optimize_Model_Container_Viewedproducts::COOKIE_NAME];
        ...
        setcookie(Ves_Optimize_Model_Container_Viewedproducts::COOKIE_NAME, $cookieIds, 0, '/');
    }
