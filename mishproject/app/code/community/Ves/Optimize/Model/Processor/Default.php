...
class Ves_Optimize_Model_Processor_Default
{
    /**
    ...
    public function replaceContentToPlaceholderReplacer($content)
    {
        ...
        try {
            foreach ($placeholders as $definition) {
                $this->_placeholder = Mage::getModel('ves_optimize/container_placeholder', $definition);
    ...
    {
        $content = $this->replaceContentToPlaceholderReplacer($response->getBody());
        return $content;
    }
     ...
     * @return string
     */
    public function getPageIdInApp(Ves_Optimize_Model_Processor $processor)
    {
     ...
     * @return string
     */
    public function getRequestUri(Ves_Optimize_Model_Processor $processor,
