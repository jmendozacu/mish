...
class Ves_Optimize_Model_Processor_Category extends Ves_Optimize_Model_Processor_Default
{
    /**
    ...
    public function allowCache(Zend_Controller_Request_Http $request)
    {
        ...
        if ($res) {
            ...
            $maxDepth = Mage::getStoreConfig(Ves_Optimize_Model_Processor::XML_PATH_ALLOWED_DEPTH);
    ...
    {
        Ves_Optimize_Model_Cookie::setCategoryViewedCookieValue(
