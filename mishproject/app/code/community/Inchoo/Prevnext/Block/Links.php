...
class Inchoo_Prevnext_Block_Links extends Mage_Core_Block_Template
{
     ...
     */
    public function getPreviousProduct($image='')
    {
        return $this->helper('inchoo_prevnext')->getPreviousProduct($image);
    }
    /**
     * @return Mage_Catalog_Model_Product
     */
    public function getNextProduct($image='')
    {
        return $this->helper('inchoo_prevnext')->getNextProduct($image);
    }
}
