...
class Magestore_Storepickup_Model_Mysql4_Store extends Mage_Core_Model_Mysql4_Abstract {
    ...
    public function getValidTime($date, $store_id) {
        ...
        $sql = $this->_getReadAdapter()->select()
                ->distinct()
                ->from(array('ss' => $prefixTable . 'storepickup_store'), array($date_field . "_open as open_time", $date_field . "_close as close_time", $date_field . "_time_interval as interval_time", $date_field . "_status as status"))
