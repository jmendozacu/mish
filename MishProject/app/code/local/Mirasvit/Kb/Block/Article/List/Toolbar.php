<?php
class Mirasvit_Kb_Block_Article_List_Toolbar extends Mage_Core_Block_Template
{
    ...
    {
        $pagerBlock = $this->getLayout()->createBlock('kb/article_list_pager', 'kb.article.pager');
...
class Mirasvit_Kb_Block_Article_List_Pager extends Mage_Page_Block_Html_Pager
{
    public function getPagerUrl($params=array())
    {
        $url = parse_url($_SERVER["REQUEST_URI"], PHP_URL_PATH);
