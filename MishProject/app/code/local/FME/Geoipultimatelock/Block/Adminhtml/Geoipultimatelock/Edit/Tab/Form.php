...
class FME_Geoipultimatelock_Block_Adminhtml_Geoipultimatelock_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('priority', 'text', array(
            ...
            'required' => true,
            'name' => 'priority',
            'after_element_html' => Mage::helper('geoipultimatelock')->__('<p><small>%s</small></p>','The group with higher priority will be selected. 0 has the higher priority!')
        ));
        ...
        $fieldset->addField('stores', 'multiselect', array(
            ...
            'after_element_html' => Mage::helper('geoipultimatelock')->__('<p><small>%s</small></p>','Rule will be applied in the selected store(s)')
        ));
        ...
        $fieldset->addField('cms_pages', 'multiselect', array(
            ...
            'after_element_html' => Mage::helper('geoipultimatelock')->__('<p><small>%s</small></p>','The access to the selected page(s) will be blocked according to the above selected store(s)!')
        ));
        ...
        $fieldset->addField('redirect_url', 'text', array(
            ...
            'name' => 'redirect_url',
            'class' => 'validate-url',
            'after_element_html' => Mage::helper('geoipultimatelock')->__('<p><small>%s</small></p>', 'Redirect will not work on category page')
        ));
        ...
        $fieldset->addField('notes', 'editor', array(
            'name' => 'notes',
            'label' => Mage::helper('geoipultimatelock')->__('Display Message'),
            'title' => Mage::helper('geoipultimatelock')->__('Display Message'),
        ...
        $fieldset->addField('ips_exception', 'textarea', array(
            ...
            'required' => false,
            'after_element_html' => Mage::helper('geoipultimatelock')->__('<p><small>%s</small></p>', 'Provide ip\'s separated by ",". Wrong type of ips will be ignored!')
        ));
