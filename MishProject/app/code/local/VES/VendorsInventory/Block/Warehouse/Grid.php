 ...
 */
class VES_VendorsInventory_Block_Warehouse_Grid extends Mage_Adminhtml_Block_Widget_Grid {
...
//            'header' => Mage::helper('inventoryplus')->__('Primary Warehouse'),
//            'align' => 'center',
//            'width' => '80px',
//            'index' => 'is_root',
//            'type' => 'options',
...
//                0 => $this->__('No'),
//            ),
//            'renderer' => 'vendorsinventory/warehouse_renderer_rootwarehouse'
//        ));
        ...
        $this->addColumn('action', array(
            ...
            'filter' => false,
            'renderer' => 'vendorsinventory/warehouse_renderer_action',
            'sortable' => false,
            'index' => 'stores',
            'is_system' => true,
        ));
