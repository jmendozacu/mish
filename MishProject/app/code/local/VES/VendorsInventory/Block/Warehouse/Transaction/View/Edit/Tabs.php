 ...
 */
class VES_VendorsInventory_Block_Warehouse_Transaction_View_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
    ...
    protected function _beforeToHtml() {
        $this->addTab('form_section', array(
            ...
            'content' => $this->getLayout()
                    ->createBlock('vendorsinventory/warehouse_transaction_view_edit_tab_form')
                    ->toHtml(),
        ));
        ...
        $this->addTab('products_section', array(
            ...
            'content' => $this->getLayout()
                    ->createBlock('vendorsinventory/warehouse_transaction_view_edit_tab_products')
                    ->toHtml(),
        ));
