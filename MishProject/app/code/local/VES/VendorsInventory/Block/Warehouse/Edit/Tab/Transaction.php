 ...
 */
class VES_VendorsInventory_Block_Warehouse_Edit_Tab_Transaction extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('transaction_object', array(
            ...
            'sortable' => true,
            'renderer' => 'vendorsinventory/warehouse_edit_tab_renderer_transactionobject',
        ...
        $this->addColumn('action', array(
            ...
            'actions' => array(
                array(
                    ...
                    'url' => array('base' => 'vendors/inventory_warehouse/viewtransaction',
