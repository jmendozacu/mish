...
class VES_VendorsInventory_Block_Adjuststock_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function __construct() {
        ...
        if (($this->getAdjustStock() && $this->getAdjustStock()->getId()) || Mage::getModel('vendors/session')->getData('adjuststock_product_import')) {
    ...
    protected function _prepareCollection() {        
        ...
        if ($this->getRequest()->getParam('id')) {
            ...
            $productSkus = array();
            if ($adjustStockProducts = Mage::getModel('vendors/session')->getData('adjuststock_product_warehouse')) {
