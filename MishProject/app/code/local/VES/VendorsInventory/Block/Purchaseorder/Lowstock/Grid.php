...
class VES_VendorsInventory_Block_Purchaseorder_Lowstock_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        $awaitingPOids = $this->helper('vendorsinventory/purchaseorder')->getAwaitingPOids();
        ...
        $productIds = $this->helper('vendorsinventory/supplier')->getProductIdsFromSuppliers($supplierIds);
    ...
    protected function _helper() {
        return $this->helper('vendorsinventory/lowstock');
    }
