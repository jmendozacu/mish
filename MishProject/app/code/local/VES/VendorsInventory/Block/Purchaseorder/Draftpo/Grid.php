 ...
 */
class VES_VendorsInventory_Block_Purchaseorder_Draftpo_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('action',
            array(
                ...
                'index'        => 'stores',
                'is_system'    => true,
                'renderer' => 'vendorsinventory/purchaseorder_draftpo_renderer_action',
        ));
        ...
        foreach ($warehouseIds as $warehouseId) {
            $this->addColumn('warehouse_' . $warehouseId, array(
                ...
                'width' => '50px',
                'renderer' => 'vendorsinventory/purchaseorder_draftpo_renderer_warehouseqty',
            ));
        }
    }
