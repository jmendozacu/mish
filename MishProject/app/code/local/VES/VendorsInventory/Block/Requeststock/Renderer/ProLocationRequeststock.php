 ...
 */
class VES_VendorsInventory_Block_Requeststock_Renderer_ProLocationRequeststock extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        /* create new request stock */ elseif ($source && $source != 'others') {
