 ...
 */
class VES_VendorsInventory_Block_Sendstock_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $this->setForm($form);
        $data = '';
        if (Mage::getSingleton('vendors/session')->getSendStockData()) {
            $data = Mage::getSingleton('vendors/session')->getSendStockData();
            Mage::getSingleton('vendors/session')->setSendStockData(null);
        ...
        $sourceOptions = Mage::helper('vendorsinventory/sendstock')->getWarehouseByAdmin();
        $targetOptions = Mage::helper('vendorsinventory/sendstock')->getAllWarehouseSendstockforDestination();
            ...
            if (!$source && !$target) {
                ...
                function continueTransfer(){
                        if($("warehouse_id_from").value != $("warehouse_id_to").value){
                            var url = "' . $this->getUrl('vendors/inventory_sendstock/new') . 'source/"+$("warehouse_id_from").value+"/target/"+$("warehouse_id_to").value;
