 ...
 */
class VES_VendorsInventory_Block_Supplier_Edit_Tab_Renderer_Showreport extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {

    public function render(Varien_Object $row) {
        $productId = $row->getEntityId();
        $supplierId = Mage::app()->getRequest()->getParam('id');
        $supplier = Mage::helper('vendorsinventory/supplier')->getAllSupplierName();
