 ...
 */
class VES_VendorsInventory_Block_Supplier_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
    ...
    protected function _beforeToHtml() {
        ...
        //add dashboard tabs into supplier
        Mage::dispatchEvent('ves_vendorsinventory_add_dashboard_tab_supplier', array('tab' => $this, 'supplier' => $supplier));
        ...
        $this->addTab('form_section', array(
            ...
            'content' => $this->getLayout()
                    ->createBlock('vendorsinventory/supplier_edit_tab_form')
                    ->toHtml(),
        ));
        ...
        if ($this->getRequest()->getParam('id')) {
            ...
            $this->addTab('returnorder_section', array(
             ...
             Mage::dispatchEvent('ves_vendorsinventory_add_supplier_tabs', array('tabs' => $this));
