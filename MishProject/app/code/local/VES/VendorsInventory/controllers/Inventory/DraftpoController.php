...
class VES_VendorsInventory_Inventory_DraftpoController extends VES_Vendors_Controller_Action{
   ...
   public function viewAction() {
    ...
    public function masschangesupplierAction() {
        ...
        try {
            ...
            Mage::getSingleton('vendors/session')->addSuccess($this->helper()->__('The supplier(s) has been changed successully.'));
            $this->_redirect('*/*/view', array('id' => $id));
        } catch (Exception $e) {
            Mage::getSingleton('vendors/session')->addError($this->helper()->__('An error has been occurred when changing suppliers. Please try again.'));
            Mage::getSingleton('vendors/session')->addError($e->getMessage());
            $this->_redirect('*/*/view', array('id' => $id));
        }
    }
    ...
    public function helper() {
        return Mage::helper('vendorsinventory/draftpo');
    }
