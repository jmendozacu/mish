 ...
 */
class VES_VendorsReport_Helper_Stockonhand extends Mage_Core_Helper_Abstract {
...
//        );
        ...
        $collection->getSelect()->join(
                array('warehouse' => $collection->getTable('inventoryplus/warehouse')), 'warehouseproduct.warehouse_id = warehouse.warehouse_id and warehouse.vendor_id='.$vendorId, array('warehouse_id')
        );
