 ...
 */
class VES_VendorsReport_Helper_Order extends Mage_Core_Helper_Abstract {
    ...
    public function getOrderCollection() {
        ...
        return Mage::getResourceModel('inventoryreports/sales_order_collection')->addFieldToFilter('main_table.vendor_id',$vendorId);
    }
    ...
    public function getOrderItemCollection() {
        $vendorId = Mage::getSingleton('vendors/session')->getUser()->getId();
        return Mage::getResourceModel('inventoryreports/sales_order_item_collection')->addFieldToFilter('main_table.vendor_id',$vendorId);
    }
