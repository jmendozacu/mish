<?php
class VES_VendorsReport_Block_Header_Others extends Magestore_Inventoryreports_Block_Adminhtml_Header
{
    /**
    ...
    {
        $this->setTemplate('ves_vendorsinventory/reports/header/others.phtml');
