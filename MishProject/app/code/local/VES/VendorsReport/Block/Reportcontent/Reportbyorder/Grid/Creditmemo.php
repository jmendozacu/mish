...
class VES_VendorsReport_Block_Reportcontent_Reportbyorder_Grid_Creditmemo extends Mage_Adminhtml_Block_Widget_Grid {
...
//        $this->addExportType('*/*/exportInvoicedExcel', Mage::helper('adminhtml')->__('Excel XML'));
    ...
    public function getGridUrl() {
        return $this->getUrl('vendors/report_report/reportcreditmemogrid', array('type_id' => 'sales', 'top_filter' => $this->getRequest()->getParam('top_filter')));
    }
