 ...
 */ 
class VES_VendorsReport_Block_Reportcontent_Reportbyorder_Chart extends Magestore_Inventoryreports_Block_Adminhtml_Reportcontent_Chart {
    ...
    public function getDataCollection() {
        if (!$this->hasData('data_collection')) {
            ...
            $collection = Mage::helper('vendorsreport/order')->getOrderReportCollection($requestData);
    ...
    public function getTotalData() {
        if (Mage::registry('total_data') === null) {
            ...
            if($this->isSalesSupplierReport()){
                $item = $this->helper('vendorsreport/order')->getUnassignedSupplierSales($this->getRequestData());
