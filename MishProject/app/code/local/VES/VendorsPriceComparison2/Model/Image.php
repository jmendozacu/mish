<?php
class VES_VendorsPriceComparison2_Model_Image extends Mage_Core_Model_Abstract
{
    protected $_width;
    protected $_height;
...
//        print '$this->_getNeedMemoryForBaseFile() = '.$this->_getNeedMemoryForBaseFile();
    ...
    public function setBaseFile($file)
    {
        ...
        $path = array(
            Mage::getBaseDir('media').DS."ves_vendorspricecomparison",
            'cache',
        );
...
//            }
    ...
    {
        $directory = Mage::getBaseDir('media') . DS.'ves_vendorspricecomparison'.DS.'cache'.DS;
