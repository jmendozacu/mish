...
class VES_VendorsMap_Block_Vendor_Account_Map extends Mage_Adminhtml_Block_Abstract implements Varien_Data_Form_Element_Renderer_Interface
{
	public function __construct(){
		$this->setTemplate("ves_vendorsmap/map.phtml");
	}
	...
	public function getListAddressHtml(){
		$block = $this->getLayout()->createBlock("vendorsmap/vendor_account_sidebar")->setMap($this->getMapCollection());
		return $block->toHtml();
	}
	
	public function getFormNewHtml(){
		$block = $this->getLayout()->createBlock("vendorsmap/vendor_account_new");
		return $block->toHtml();
	}
