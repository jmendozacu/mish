...
$this->addAttribute('ves_vendor', 'birthday', array(
        'type'              => 'varchar',
        'label'             => 'birthday',
        'input'             => 'text',
        'class'             => '',
...
$this->addAttribute('ves_vendor', 'sex', array(
        'type'              => 'varchar',
        'label'             => 'sex',
        'input'             => 'text',
        'class'             => '',
...
$this->addAttribute('ves_vendor', 'passport', array(
        'type'              => 'varchar',
        'label'             => 'passport',
        'input'             => 'text',
        'class'             => '',
...
$this->addAttribute('ves_vendor', 'roomaddress', array(
        'type'              => 'varchar',
        'label'             => 'roomaddress',
        'input'             => 'text',
        'class'             => '',
