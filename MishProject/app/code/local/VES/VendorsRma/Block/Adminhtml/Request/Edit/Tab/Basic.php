...
class VES_VendorsRma_Block_Adminhtml_Request_Edit_Tab_Basic extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        $form = new Varien_Data_Form();
        $this->setForm($form);
        $fieldset = $form->addFieldset('basic_form', array('legend'=>Mage::helper('vendorsrma')->__('Add New RMA')));


        $pack = Mage::getModel("vendorsrma/option_vendor")->getOptions();
        $vendor =  $fieldset->addField('vendor_id', 'select', array(
            'label'     => Mage::helper('vendorsrma')->__('Seller Name'),
