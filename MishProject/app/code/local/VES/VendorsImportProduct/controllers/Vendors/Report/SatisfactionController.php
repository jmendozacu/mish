...
class VES_VendorsImportProduct_Vendors_Report_SatisfactionController extends VES_Vendors_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->_initAction();
        $gridBlock = $this->getLayout()->getBlock('vendors_report_satisfaction.grid');
    ...
    public function exportCsvAction()
    {
        ...
        $grid       = $this->getLayout()->createBlock('helpdesk/vendors_report_satisfaction_grid');
