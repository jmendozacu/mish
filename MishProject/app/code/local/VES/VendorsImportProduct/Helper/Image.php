<?php
class VES_VendorsImportProduct_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    public function init($imageFile=null,VES_Vendors_Model_Vendor $vendor)
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('vendorsimport/image'));
        $this->_getModel()->setVendor($vendor);
	...
	public function delete(){
        ...
        $cachedFile = str_replace("/", DS, $this->_getModel()->getNewFile());
		if(file_exists($cachedFile)){
			@unlink($cachedFile);
		}
		@unlink($this->_getModel()->getBaseFile());
	}
