<?php
class VES_VendorsImportProduct_Model_Image extends Mage_Core_Model_Abstract
{
    protected $_width;
    protected $_height;
...
//        print '$this->_getNeedMemoryForBaseFile() = '.$this->_getNeedMemoryForBaseFile();
    ...
    public function setBaseFile($file)
    {
        ...
        $path = array(
            Mage::getBaseDir('media').DS."ves_vendorsimportproduct".DS.$this->getVendor()->getVendorId(),
            'cache',
        );
...
//            }
    ...
    {
        $directory = Mage::getBaseDir('media') . DS.'ves_bannermanager'.DS.'cache'.DS;
