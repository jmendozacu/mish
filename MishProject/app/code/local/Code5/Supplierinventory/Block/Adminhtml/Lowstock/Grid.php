...
class Code5_Supplierinventory_Block_Adminhtml_Lowstock_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        if (Mage::helper('catalog')->isModuleEnabled('Mage_CatalogInventory')) {
            $collection->joinField('qty', 'cataloginventory/stock_item', 'qty', 'product_id=entity_id', '{{table}}.stock_id=1 and {{table}}.qty<10', 'inner');
        }
        if ($store->getId()) {
        ...
        $collection->setOrder('vendor_id', 'DESC');
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumnAfter('vendor', array(
