 ...
 */
class Amasty_Promocopy_Block_Vendors_Promo_Quote_Grid extends Mage_Adminhtml_Block_Promo_Quote_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('promocopygrid');
 ...
 return parent::_prepareCollection();
        ...
        $this->addColumn('action',array(
            ...
            'actions'   => array(
                array(
                    ...
                    'url'     => array('base' => 'Promocopy/index/duplicate'),
                    'field'   => 'rule_id'
                )
            ),
            'filter'    => false,
    ...
    protected function addAction($label, $urlKey='', $isConfim=false)   
    {
        $this->getMassactionBlock()->addItem(str_replace('/', '_', $urlKey), array(
             'label'    => $this->__($label),
             'url'      => $this->getUrl('vendors/promocopy_index/index/'. $urlKey),
