...
class MageWorx_SeoBase_Model_Canonical_Product extends MageWorx_SeoBase_Model_Canonical_Abstract
{
    ...
    /**
     * @param Mage_Catalog_Model_Product|null
     * @return string
     */
    protected function _getCanonicalUrl($item = null)
    {
        ...
        if ($personalCanonicalUrlCode) {
            ...
            if ($personalCanonicalUrl) {
                ...
                $canonicalUrl = $this->_helperStore->getStoreBaseUrl($storeId) . ltrim($personalCanonicalUrl, '/');
                return $this->escapeUrl($canonicalUrl);
            }
        }
