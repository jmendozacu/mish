<?php
class Ves_Deals_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    public function getFilterUrl( $filter_deal = 1 ){
    	if(!$filter_deal) {
    		return Mage::getBaseUrl().Mage::getStoreConfig('ves_deals/deals_setting/route');
    	} else {
    		return Mage::getBaseUrl().Mage::getStoreConfig('ves_deals/deals_setting/route')."/filter/".$filter_deal.".html";
    	}
	}
}
?>