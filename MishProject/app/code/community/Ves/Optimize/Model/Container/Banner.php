 ...
 * @license     http://www.magentocommerce.com/license/ves-edition
 */
class Ves_Optimize_Model_Container_Banner
    extends Ves_Optimize_Model_Container_Abstract
{
    ...
    protected function _getCacheId()
    {
        ...
        return 'CONTAINER_BANNER_'
            ...
            . '_' .  $this->_getCookieValue(Ves_Optimize_Model_Cookie::CUSTOMER_SEGMENT_IDS, '');
    }
    ...
    protected function _selectBannersToRender($renderedParams)
    {
        ...
        switch ($rotate) {
            case Ves_Banner_Block_Widget_Banner::BANNER_WIDGET_RORATE_RANDOM:
                $bannerId = $bannerIds[array_rand($bannerIds, 1)];
                $result = array($bannerId);
                break;

            case Ves_Banner_Block_Widget_Banner::BANNER_WIDGET_RORATE_SERIES:
            case Ves_Banner_Block_Widget_Banner::BANNER_WIDGET_RORATE_SHUFFLE:
                $isShuffle = $rotate == Ves_Banner_Block_Widget_Banner::BANNER_WIDGET_RORATE_SHUFFLE;
                $bannerId = null;
