 ...
 */
class Ves_Optimize_Model_Container_Wishlist extends Ves_Optimize_Model_Container_Abstract
{
    /**
    ...
    {
        return $this->_getCookieValue(Ves_Optimize_Model_Cookie::COOKIE_WISHLIST_ITEMS, '')
            . $this->_getCookieValue(Ves_Optimize_Model_Cookie::COOKIE_WISHLIST, '')
            . ($this->_getCookieValue(Ves_Optimize_Model_Cookie::COOKIE_CUSTOMER_GROUP, ''));
    }
