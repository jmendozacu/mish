 ...
 */
class Ves_Optimize_Model_Container_Accountlinks extends Ves_Optimize_Model_Container_Customer
{
    /**
    ...
    protected function _renderBlock()
    {
        ...
        if (!$this->_getCookieValue(Ves_Optimize_Model_Cookie::COOKIE_CUSTOMER)
            || $this->_getCookieValue(Ves_Optimize_Model_Cookie::COOKIE_CUSTOMER_LOGGED_IN)
        ) {
