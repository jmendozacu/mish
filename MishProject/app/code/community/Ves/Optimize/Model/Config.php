...
class Ves_Optimize_Model_Config extends Varien_Simplexml_Config
{
     ...
     * @return Ves_Optimize_Model_Config
     */
     ...
     * @return Ves_Optimize_Model_Container_Placeholder
     */
    public function getBlockPlaceholder($block)
    {
        ...
        if (isset($this->_placeholders[$type])) {
            ...
            $placeholder = Mage::getModel('ves_optimize/container_placeholder', $placeholder);
            return $placeholder;
        }
        return false;
    }
