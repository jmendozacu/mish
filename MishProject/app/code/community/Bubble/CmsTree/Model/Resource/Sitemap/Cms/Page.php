 ...
 */
class Bubble_CmsTree_Model_Resource_Sitemap_Cms_Page extends Bubble_CmsTree_Model_Resource_Sitemap_Cms_Page_Amasty_Pure
{
    /**
     * Initialization
     */
    ...
    public function getCollection($storeId)
    {
        ...
        $suffix = Mage::helper('bubble_cmstree')->getUrlSuffix($storeId);
